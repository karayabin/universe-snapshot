...
PhpExcelTool::getRowValues
================



PhpExcelTool::getRowValues — Returns an array of the values for the row identified by rowName (the index or name of the row).
...
Source Code
===========
See the source code for method [PhpExcelTool::getRowValues](https://github.com/lingtalfi/PhpExcelTool/blob/master/PhpExcelTool.php#L120-L151)
...
Previous method: [getColumnValues](https://github.com/lingtalfi/PhpExcelTool/blob/master/doc/api/Ling/PhpExcelTool/PhpExcelTool/getColumnValues.md)<br>Next method: [getColumnsAsRows](https://github.com/lingtalfi/PhpExcelTool/blob/master/doc/api/Ling/PhpExcelTool/PhpExcelTool/getColumnsAsRows.md)<br>
