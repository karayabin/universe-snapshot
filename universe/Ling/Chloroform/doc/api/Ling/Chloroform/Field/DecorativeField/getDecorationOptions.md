...
Source Code
===========
See the source code for method [DecorativeField::getDecorationOptions](https://github.com/lingtalfi/Chloroform/blob/master/Field/DecorativeField.php#L224-L227)
