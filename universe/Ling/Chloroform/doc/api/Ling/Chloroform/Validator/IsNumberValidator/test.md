...
[Back to the Ling\Chloroform\Validator\IsNumberValidator class](https://github.com/lingtalfi/Chloroform/blob/master/doc/api/Ling/Chloroform/Validator/IsNumberValidator.md)


IsNumberValidator::test
================



IsNumberValidator::test — of the validator.
...
Source Code
===========
See the source code for method [IsNumberValidator::test](https://github.com/lingtalfi/Chloroform/blob/master/Validator/IsNumberValidator.php#L28-L39)


See Also
================

The [IsNumberValidator](https://github.com/lingtalfi/Chloroform/blob/master/doc/api/Ling/Chloroform/Validator/IsNumberValidator.md) class.
