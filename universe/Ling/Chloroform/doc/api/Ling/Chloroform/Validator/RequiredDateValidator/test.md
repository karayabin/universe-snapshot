...
Source Code
===========
See the source code for method [RequiredDateValidator::test](https://github.com/lingtalfi/Chloroform/blob/master/Validator/RequiredDateValidator.php#L23-L36)
