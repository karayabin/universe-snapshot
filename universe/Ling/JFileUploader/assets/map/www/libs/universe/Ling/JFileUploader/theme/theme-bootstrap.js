...
// default theme
//----------------------------------------
if ('undefined' === typeof window.FileUploaderTheme_Boostrap) {
    (function () {
        ...
        //
        //----------------------------------------
        window.FileUploaderTheme_Boostrap = function () {
            this.container = null;
        ...
        window.FileUploaderTheme_Boostrap.prototype = {
            //----------------------------------------
            //
            //----------------------------------------
            ...
            buildFileUploader: function (options) {
                ...
                var s = '        <div class="hidden-inputs" style="display: none"></div>\n' +
                    ...
                    '                    <button class="btn-view-text btn ' + btnColor + ' btn-sm"><i class="fas fa-list-ul btn-view-text"></i></button>\n' +
                    '                    <button class="btn-view-image btn ' + btnColor + ' btn-sm"><i class="far fa-image btn-view-image"></i></button>\n' +
                    '                </div>' +
                    '            </div>\n' +
                    '        </div>\n' +
                    '        <div class="dropzone">\n' +
                    ...
                    '        <div class="footer">\n' +
                    '            <div class="left">\n' +
                    '                <button class="btn-add-file btn btn-sm ' + btnColor + '"><i class="btn-add-file fas fa-plus-circle"></i> <span\n' +
                    '                            class="text-add-file btn-add-file">Add files</span></button>\n' +
                    '                <button class="btn-start-upload btn btn-sm ' + btnColor + '" disabled><i class="btn-start-upload fas fa-arrow-circle-right"></i> <span class="btn-start-upload text-start-upload">Start upload</span></button>\n' +
                    '            </div>\n' +
                    '            <div class="right">\n' +
        ...
        window.FileUploaderThemes.bootstrap = new FileUploaderTheme_Boostrap();
    })();
}
