...
Source Code
===========
See the source code for method [LightKitAdminService::uninstall](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Service/LightKitAdminService.php#L499-L582)
