...
RealAdminPageController::setOnSuccessIframeSignal
================



RealAdminPageController::setOnSuccessIframeSignal — Sets the iframeSignal to use in case of a valid form.
...
public [RealAdminPageController::setOnSuccessIframeSignal](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/RealAdminPageController/setOnSuccessIframeSignal.md)(string $iframeSignal) : void
...
Previous method: [processForm](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/RealAdminPageController/processForm.md)<br>
