...
RealAdminPageController::processForm
================



RealAdminPageController::processForm — or a response directly.
...
Source Code
===========
See the source code for method [RealAdminPageController::processForm](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/Controller/RealAdminPageController.php#L86-L108)
...
Previous method: [render](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/RealAdminPageController/render.md)<br>Next method: [setOnSuccessIframeSignal](https://github.com/lingtalfi/Light_Kit_Admin/blob/master/doc/api/Ling/Light_Kit_Admin/Controller/RealAdminPageController/setOnSuccessIframeSignal.md)<br>
