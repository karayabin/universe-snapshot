...
class LudPluginOptionController extends RealGenController
{
    ...
    {
        return $this->renderAdminPage('Light_Kit_Admin/kit/zeroadmin/generated/lud_plugin_option_list', [], PageConfUpdator::create()->updateWidget("body.light_realist", [
            'vars' => [
                'request_declaration_id' => 'Light_Kit_Admin:generated/lud_plugin_option',
            ],
        ]));
    }
    ...
    public function renderForm()
    {
        ...
        $identifier = "Light_Kit_Admin.generated/lud_plugin_option";
        ...
        // RENDERING
        //--------------------------------------------
        return $this->renderAdminPage('Light_Kit_Admin/kit/zeroadmin/generated/lud_plugin_option_form', [
