...
class <span class="pl-k">LoopLabTwoColumnsTeaserWidget</span> extends PicassoWidget implements UniversalTemplateEngineInterface {
...
Location
=============
Ling\Light_Kit_BootstrapWidgetLibrary\Widget\Picasso\LoopLabTwoColumnsTeaserWidget
