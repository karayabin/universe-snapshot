...
PhotoGalleryWidget::__construct
================



PhotoGalleryWidget::__construct — Builds the PicassoWidget instance.
...
public [PhotoGalleryWidget::__construct](https://github.com/lingtalfi/Light_Kit_BootstrapWidgetLibrary/blob/master/doc/api/Ling/Light_Kit_BootstrapWidgetLibrary/Widget/Picasso/PhotoGalleryWidget/__construct.md)() : void
...
Source Code
===========
See the source code for method [PhotoGalleryWidget::__construct](https://github.com/lingtalfi/Light_Kit_BootstrapWidgetLibrary/blob/master/Widget/Picasso/PhotoGalleryWidget.php#L19-L27)
