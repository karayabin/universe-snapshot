 ...
 */
abstract class LightKitBootstrapWidgetLibraryBaseCommand implements CommandInterface, LightCliCommandInterface, LightServiceContainerAwareInterface
{

    /**
     * This property holds the LightKitBootstrapWidgetLibraryApplication instance.
     * @var LightKitBootstrapWidgetLibraryApplication
     */
    protected LightKitBootstrapWidgetLibraryApplication $application;
    ...
    /**
     * Builds the LightKitBootstrapWidgetLibraryBaseCommand instance.
     */
    ...
    public function run(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            ...
            if ($this->container->has('logger')) {
                ...
                $lg->log($errorMsg, LightKitBootstrapWidgetLibraryHelper::getAppId() . "_error");
            }
     ...
     *
     * @param LightKitBootstrapWidgetLibraryApplication $application
     */
    public function setApplication(LightKitBootstrapWidgetLibraryApplication $application)
    {
...
<info>Tip: use the -u flag to override this warning.</info>" . PHP_EOL
    ...
    {
        throw new LightKitBootstrapWidgetLibraryException(static::class . ": " . $msg, $code);
    }
}