...
/**
 * @var $this KitStoreHeaderWidget
 */


use Ling\Light_Kit_BootstrapWidgetLibrary\Widget\Picasso\KitStoreHeaderWidget;
...
<li class="kit-bwl-kit_store_header_widget nav-item dropdown d-none d-md-inline-block pb-1 <?php echo htmlspecialchars($this->getCssClass()); ?>" <?php echo $this->getAttributesHtml(); ?>>
