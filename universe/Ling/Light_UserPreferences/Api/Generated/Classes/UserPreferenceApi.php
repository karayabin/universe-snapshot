...
namespace Ling\Light_UserPreferences\Api\Generated\Classes;
...
use Ling\Light_UserPreferences\Api\Custom\Classes\CustomLightUserPreferencesBaseApi;
 ...
 */
class UserPreferenceApi extends CustomLightUserPreferencesBaseApi implements UserPreferenceApiInterface
{
    ...
    {
        $this->pdoWrapper->update($this->table, $userPreference, $where, $markers);
    }
