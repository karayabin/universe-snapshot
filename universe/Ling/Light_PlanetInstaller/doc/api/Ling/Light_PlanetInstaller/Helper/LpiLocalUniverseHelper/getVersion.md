...
LpiLocalUniverseHelper::getVersion
================



LpiLocalUniverseHelper::getVersion — Returns the current version of the given planet from the local universe.
...
public static [LpiLocalUniverseHelper::getVersion](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiLocalUniverseHelper/getVersion.md)(string $planetDot) : string
