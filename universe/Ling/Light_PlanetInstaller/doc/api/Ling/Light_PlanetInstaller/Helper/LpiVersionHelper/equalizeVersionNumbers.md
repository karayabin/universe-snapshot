...
LpiVersionHelper::equalizeVersionNumbers
================



LpiVersionHelper::equalizeVersionNumbers — Equalizes the two given real version numbers, so that they have the same number of dot separated components.
