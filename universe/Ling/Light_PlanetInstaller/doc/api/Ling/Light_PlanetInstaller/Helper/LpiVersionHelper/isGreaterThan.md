...
LpiVersionHelper::isGreaterThan
================



LpiVersionHelper::isGreaterThan — Returns whether real version 1 is greater than or equal to real version 2.
...
public static [LpiVersionHelper::isGreaterThan](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiVersionHelper/isGreaterThan.md)(string $v1, string $v2) : bool
...
Previous method: [versionMeetsExpectations](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiVersionHelper/versionMeetsExpectations.md)<br>Next method: [shouldBeReplaced](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiVersionHelper/shouldBeReplaced.md)<br>
