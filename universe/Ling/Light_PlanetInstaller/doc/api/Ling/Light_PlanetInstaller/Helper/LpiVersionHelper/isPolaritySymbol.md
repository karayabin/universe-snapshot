...
LpiVersionHelper::isPolaritySymbol
================



LpiVersionHelper::isPolaritySymbol — Returns whether the given modifierSymbol is a polarity symbol.
...
public static [LpiVersionHelper::isPolaritySymbol](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiVersionHelper/isPolaritySymbol.md)(string $modifierSymbol) : bool
...
Previous method: [extractMiniVersion](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiVersionHelper/extractMiniVersion.md)<br>Next method: [versionMeetsExpectations](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Helper/LpiVersionHelper/versionMeetsExpectations.md)<br>
