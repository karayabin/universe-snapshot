...
Source Code
===========
See the source code for method [LpiHelper::getPlanetInstallerInstance](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/Helper/LpiHelper.php#L69-L80)
