...
LightPlanetInstallerInit2HookInterface::init2
================



LightPlanetInstallerInit2HookInterface::init2 — Executes the init 2 phase of the install command.
...
Source Code
===========
See the source code for method [LightPlanetInstallerInit2HookInterface::init2](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/PlanetInstaller/LightPlanetInstallerInit2HookInterface.php#L26-L26)
...
Next method: [undoInit2](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/PlanetInstaller/LightPlanetInstallerInit2HookInterface/undoInit2.md)<br>
