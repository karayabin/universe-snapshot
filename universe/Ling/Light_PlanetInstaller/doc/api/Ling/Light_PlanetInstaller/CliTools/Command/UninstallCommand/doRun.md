...
UninstallCommand::doRun
================



UninstallCommand::doRun — Runs the command.
...
Next method: [getDescription](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/UninstallCommand/getDescription.md)<br>
