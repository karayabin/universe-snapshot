...
UninstallCommand::getParameters
================



UninstallCommand::getParameters — Returns the parameters available for this command.
...
public [UninstallCommand::getParameters](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/UninstallCommand/getParameters.md)() : array
