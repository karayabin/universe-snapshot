...
Source Code
===========
See the source code for method [ImportCommand::getFlags](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/ImportCommand.php#L183-L198)
