...
- [OpenDirCommand::doRun](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/OpenDirCommand/doRun.md) &ndash; Runs the command.
...
Location
=============
Ling\Light_PlanetInstaller\CliTools\Command\OpenDirCommand<br>
See the source code of [Ling\Light_PlanetInstaller\CliTools\Command\OpenDirCommand](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/OpenDirCommand.php)



SeeAlso
==============
Previous class: [OpenConfCommand](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/OpenConfCommand.md)<br>Next class: [OpenMasterCommand](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/OpenMasterCommand.md)<br>
