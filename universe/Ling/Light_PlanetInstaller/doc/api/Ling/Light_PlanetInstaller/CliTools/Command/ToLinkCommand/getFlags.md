...
ToLinkCommand::getFlags
================



ToLinkCommand::getFlags — Returns the array of flags available for this command, which form is name => description.
...
public [ToLinkCommand::getFlags](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/ToLinkCommand/getFlags.md)() : array
...
Source Code
===========
See the source code for method [ToLinkCommand::getFlags](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/ToLinkCommand.php#L85-L93)
