...
InstallCommand::phaseTitle
================



InstallCommand::phaseTitle — Writes a phase title to the output.
...
Previous method: [getAliases](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/InstallCommand/getAliases.md)<br>Next method: [processInitPhase](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/InstallCommand/processInitPhase.md)<br>
