...
ExploreConflictsCommand::stepQuit
================



ExploreConflictsCommand::stepQuit — Prints a quit message.
...
Source Code
===========
See the source code for method [ExploreConflictsCommand::stepQuit](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/ExploreConflictsCommand.php#L276-L279)
...
Previous method: [stepConflictDetail](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/ExploreConflictsCommand/stepConflictDetail.md)<br>Next method: [banner](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/ExploreConflictsCommand/banner.md)<br>
