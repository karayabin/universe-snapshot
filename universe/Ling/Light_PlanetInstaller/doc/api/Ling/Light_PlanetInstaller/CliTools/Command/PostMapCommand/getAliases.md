...
PostMapCommand::getAliases
================



PostMapCommand::getAliases — Returns the aliases used by this command.
...
public [PostMapCommand::getAliases](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/PostMapCommand/getAliases.md)() : array
...
Previous method: [getParameters](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/PostMapCommand/getParameters.md)<br>
