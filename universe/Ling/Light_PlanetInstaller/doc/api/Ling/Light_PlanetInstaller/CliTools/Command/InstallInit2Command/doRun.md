...
Source Code
===========
See the source code for method [InstallInit2Command::doRun](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/InstallInit2Command.php#L38-L42)
