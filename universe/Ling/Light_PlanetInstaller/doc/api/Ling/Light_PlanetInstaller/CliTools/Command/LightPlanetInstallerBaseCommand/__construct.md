...
LightPlanetInstallerBaseCommand::__construct
================



LightPlanetInstallerBaseCommand::__construct — Builds the LightPlanetInstallerBaseCommand instance.
...
Source Code
===========
See the source code for method [LightPlanetInstallerBaseCommand::__construct](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/LightPlanetInstallerBaseCommand.php#L48-L50)
...
Next method: [doRun](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/LightPlanetInstallerBaseCommand/doRun.md)<br>
