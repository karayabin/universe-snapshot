...
UninstallCommand::getAliases
================



UninstallCommand::getAliases — Returns the aliases used by this command.
...
public [UninstallCommand::getAliases](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/UninstallCommand/getAliases.md)() : array
...
Source Code
===========
See the source code for method [UninstallCommand::getAliases](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/UninstallCommand.php#L103-L111)
