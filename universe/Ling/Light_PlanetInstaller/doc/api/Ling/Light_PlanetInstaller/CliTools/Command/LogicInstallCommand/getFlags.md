...
LogicInstallCommand::getFlags
================



LogicInstallCommand::getFlags — Returns the array of flags available for this command, which form is name => description.
...
public [LogicInstallCommand::getFlags](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/LogicInstallCommand/getFlags.md)() : array
...
Previous method: [getParameters](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/LogicInstallCommand/getParameters.md)<br>
