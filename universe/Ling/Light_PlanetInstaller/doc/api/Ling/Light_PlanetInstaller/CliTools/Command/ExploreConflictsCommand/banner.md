...
ExploreConflictsCommand::banner
================



ExploreConflictsCommand::banner — Prints a banner to the output.
...
Source Code
===========
See the source code for method [ExploreConflictsCommand::banner](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/CliTools/Command/ExploreConflictsCommand.php#L287-L292)
...
Previous method: [stepQuit](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/ExploreConflictsCommand/stepQuit.md)<br>
