...
DebugSessionDirCommand::getDescription
================



DebugSessionDirCommand::getDescription — Returns the description of the command.
...
public [DebugSessionDirCommand::getDescription](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/CliTools/Command/DebugSessionDirCommand/getDescription.md)() : string
