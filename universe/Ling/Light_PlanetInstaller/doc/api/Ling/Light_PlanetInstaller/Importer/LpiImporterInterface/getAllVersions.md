...
LpiImporterInterface::getAllVersions
================



LpiImporterInterface::getAllVersions — Returns an array of all available versions of the planet, sorted by increasing number.
...
Source Code
===========
See the source code for method [LpiImporterInterface::getAllVersions](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/Importer/LpiImporterInterface.php#L76-L76)
