...
LpiGithubImporter::getCurrentVersion
================



LpiGithubImporter::getCurrentVersion — Returns the current version number of the planet which identifier is given.
...
public [LpiGithubImporter::getCurrentVersion](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Importer/LpiGithubImporter/getCurrentVersion.md)(string $planetIdentifier) : string
...
Previous method: [hasItem](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Importer/LpiGithubImporter/hasItem.md)<br>Next method: [getLpiDependencies](https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/Importer/LpiGithubImporter/getLpiDependencies.md)<br>
