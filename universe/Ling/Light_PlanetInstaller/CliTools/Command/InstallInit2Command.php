 ...
 *
 */
class InstallInit2Command extends InstallCommand
{
    ...
    protected function doRun(InputInterface $input, OutputInterface $output)
    {
        ...
        return $this->processInitPhase($input, $output, 2);
    }
 ...
 This command triggers the <$co>init 2 phase of the install procedure</$co>(<$url>https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/pages/conception-notes.md#init-2</$url>).
 ";
    }
