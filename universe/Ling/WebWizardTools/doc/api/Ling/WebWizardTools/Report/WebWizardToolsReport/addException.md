...
WebWizardToolsReport::addException
================



WebWizardToolsReport::addException — Adds an exception to the report.
...
Source Code
===========
See the source code for method [WebWizardToolsReport::addException](https://github.com/lingtalfi/WebWizardTools/blob/master/Report/WebWizardToolsReport.php#L168-L171)
...
Previous method: [addImportant](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/Report/WebWizardToolsReport/addImportant.md)<br>
