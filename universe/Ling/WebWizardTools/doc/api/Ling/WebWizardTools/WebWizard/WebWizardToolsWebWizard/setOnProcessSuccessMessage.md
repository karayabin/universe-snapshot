...
WebWizardToolsWebWizard::setOnProcessSuccessMessage
================



WebWizardToolsWebWizard::setOnProcessSuccessMessage — Sets the onProcessSuccessMessage.
...
Previous method: [getOnProcessSuccessMessage](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/getOnProcessSuccessMessage.md)<br>Next method: [error](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/error.md)<br>
