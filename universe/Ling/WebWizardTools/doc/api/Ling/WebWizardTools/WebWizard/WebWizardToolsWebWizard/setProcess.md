...
WebWizardToolsWebWizard::setProcess
================



WebWizardToolsWebWizard::setProcess — Sets a process.
...
Returns [WebWizardToolsWebWizard](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard.md).
...
Source Code
===========
See the source code for method [WebWizardToolsWebWizard::setProcess](https://github.com/lingtalfi/WebWizardTools/blob/master/WebWizard/WebWizardToolsWebWizard.php#L267-L271)
