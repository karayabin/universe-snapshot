...
WebWizardToolsWebWizard::render
================



WebWizardToolsWebWizard::render — Displays the web wizard gui.
...
Previous method: [__construct](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/__construct.md)<br>Next method: [run](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/run.md)<br>
