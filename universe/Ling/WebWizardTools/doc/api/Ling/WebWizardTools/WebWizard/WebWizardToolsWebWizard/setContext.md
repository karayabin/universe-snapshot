...
WebWizardToolsWebWizard::setContext
================



WebWizardToolsWebWizard::setContext — Sets the context.
...
Source Code
===========
See the source code for method [WebWizardToolsWebWizard::setContext](https://github.com/lingtalfi/WebWizardTools/blob/master/WebWizard/WebWizardToolsWebWizard.php#L289-L292)
...
Previous method: [setRenderer](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/setRenderer.md)<br>Next method: [getContext](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/getContext.md)<br>
