...
WebWizardToolsWebWizard::setRenderer
================



WebWizardToolsWebWizard::setRenderer — Sets the renderer.
...
Source Code
===========
See the source code for method [WebWizardToolsWebWizard::setRenderer](https://github.com/lingtalfi/WebWizardTools/blob/master/WebWizard/WebWizardToolsWebWizard.php#L279-L282)
...
Previous method: [setProcess](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/setProcess.md)<br>Next method: [setContext](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/WebWizard/WebWizardToolsWebWizard/setContext.md)<br>
