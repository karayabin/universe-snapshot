...
WebWizardToolsProcess::setControl
================



WebWizardToolsProcess::setControl — Adds a control to this process.
...
Source Code
===========
See the source code for method [WebWizardToolsProcess::setControl](https://github.com/lingtalfi/WebWizardTools/blob/master/Process/WebWizardToolsProcess.php#L155-L159)
...
Previous method: [setWebWizard](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/Process/WebWizardToolsProcess/setWebWizard.md)<br>Next method: [getName](https://github.com/lingtalfi/WebWizardTools/blob/master/doc/api/Ling/WebWizardTools/Process/WebWizardToolsProcess/getName.md)<br>
