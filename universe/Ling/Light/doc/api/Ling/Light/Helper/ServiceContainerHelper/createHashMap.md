...
Source Code
===========
See the source code for method [ServiceContainerHelper::createHashMap](https://github.com/lingtalfi/Light/blob/master/Helper/ServiceContainerHelper.php#L221-L233)
