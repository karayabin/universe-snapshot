...
Source Code
===========
See the source code for method [ServiceContainerHelper::buildDarkBlueContainer](https://github.com/lingtalfi/Light/blob/master/Helper/ServiceContainerHelper.php#L173-L184)
