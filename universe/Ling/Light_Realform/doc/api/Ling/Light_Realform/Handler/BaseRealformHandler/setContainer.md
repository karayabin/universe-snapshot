...
BaseRealformHandler::setContainer
================



BaseRealformHandler::setContainer — Sets the light service container interface.
...
Previous method: [__construct](https://github.com/lingtalfi/Light_Realform/blob/master/doc/api/Ling/Light_Realform/Handler/BaseRealformHandler/__construct.md)<br>Next method: [setId](https://github.com/lingtalfi/Light_Realform/blob/master/doc/api/Ling/Light_Realform/Handler/BaseRealformHandler/setId.md)<br>
