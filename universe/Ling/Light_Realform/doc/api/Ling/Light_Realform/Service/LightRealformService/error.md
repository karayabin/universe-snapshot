...
LightRealformService::error
================



LightRealformService::error — Throws an exception.
...
private [LightRealformService::error](https://github.com/lingtalfi/Light_Realform/blob/master/doc/api/Ling/Light_Realform/Service/LightRealformService/error.md)(string $msg) : void
...
Source Code
===========
See the source code for method [LightRealformService::error](https://github.com/lingtalfi/Light_Realform/blob/master/Service/LightRealformService.php#L926-L929)
