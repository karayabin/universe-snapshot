...
LightRealformService::getChloroformValidator
================



LightRealformService::getChloroformValidator — Returns a validator instance.
...
Source Code
===========
See the source code for method [LightRealformService::getChloroformValidator](https://github.com/lingtalfi/Light_Realform/blob/master/Service/LightRealformService.php#L383-L470)
...
Previous method: [getChloroformField](https://github.com/lingtalfi/Light_Realform/blob/master/doc/api/Ling/Light_Realform/Service/LightRealformService/getChloroformField.md)<br>Next method: [handleFormSystemA](https://github.com/lingtalfi/Light_Realform/blob/master/doc/api/Ling/Light_Realform/Service/LightRealformService/handleFormSystemA.md)<br>
