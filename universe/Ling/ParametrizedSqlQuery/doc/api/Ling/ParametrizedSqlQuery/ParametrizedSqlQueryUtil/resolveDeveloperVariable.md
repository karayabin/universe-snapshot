...
ParametrizedSqlQueryUtil::resolveDeveloperVariable
================



ParametrizedSqlQueryUtil::resolveDeveloperVariable — Resolves the developer variables in the given expr.
...
protected [ParametrizedSqlQueryUtil::resolveDeveloperVariable](https://github.com/lingtalfi/ParametrizedSqlQuery/blob/master/doc/api/Ling/ParametrizedSqlQuery/ParametrizedSqlQueryUtil/resolveDeveloperVariable.md)(string &$expr) : void
...
Source Code
===========
See the source code for method [ParametrizedSqlQueryUtil::resolveDeveloperVariable](https://github.com/lingtalfi/ParametrizedSqlQuery/blob/master/ParametrizedSqlQueryUtil.php#L825-L829)
