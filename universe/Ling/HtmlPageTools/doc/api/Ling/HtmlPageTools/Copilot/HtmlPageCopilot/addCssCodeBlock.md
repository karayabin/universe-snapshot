...
HtmlPageCopilot::addCssCodeBlock
================



HtmlPageCopilot::addCssCodeBlock — Adds a css code block to this instance.
...
public [HtmlPageCopilot::addCssCodeBlock](https://github.com/lingtalfi/HtmlPageTools/blob/master/doc/api/Ling/HtmlPageTools/Copilot/HtmlPageCopilot/addCssCodeBlock.md)(string $codeBlock) : void
...
Source Code
===========
See the source code for method [HtmlPageCopilot::addCssCodeBlock](https://github.com/lingtalfi/HtmlPageTools/blob/master/Copilot/HtmlPageCopilot.php#L279-L282)
