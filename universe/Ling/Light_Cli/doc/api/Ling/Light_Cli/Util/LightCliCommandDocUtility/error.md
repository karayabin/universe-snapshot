...
Source Code
===========
See the source code for method [LightCliCommandDocUtility::error](https://github.com/lingtalfi/Light_Cli/blob/master/Util/LightCliCommandDocUtility.php#L450-L453)
