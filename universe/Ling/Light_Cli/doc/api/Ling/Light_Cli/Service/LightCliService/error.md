...
LightCliService::error
================



LightCliService::error — Throws an exception.
...
private [LightCliService::error](https://github.com/lingtalfi/Light_Cli/blob/master/doc/api/Ling/Light_Cli/Service/LightCliService/error.md)(string $msg) : void
...
Previous method: [getCliApps](https://github.com/lingtalfi/Light_Cli/blob/master/doc/api/Ling/Light_Cli/Service/LightCliService/getCliApps.md)<br>
