...
Source Code
===========
See the source code for method [ClassParser::setNotationlInterpreter](https://github.com/lingtalfi/DocTools/blob/master/ClassParser/ClassParser.php#L678-L681)
