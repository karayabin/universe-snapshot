...
LightCsrfSessionField::getValue
================



LightCsrfSessionField::getValue — Returns the value of the field.
...
public [LightCsrfSessionField::getValue](https://github.com/lingtalfi/Light_CsrfSession/blob/master/doc/api/Ling/Light_CsrfSession/Chloroform/Field/LightCsrfSessionField/getValue.md)() : mixed
...
Previous method: [__construct](https://github.com/lingtalfi/Light_CsrfSession/blob/master/doc/api/Ling/Light_CsrfSession/Chloroform/Field/LightCsrfSessionField/__construct.md)<br>Next method: [setContainer](https://github.com/lingtalfi/Light_CsrfSession/blob/master/doc/api/Ling/Light_CsrfSession/Chloroform/Field/LightCsrfSessionField/setContainer.md)<br>
