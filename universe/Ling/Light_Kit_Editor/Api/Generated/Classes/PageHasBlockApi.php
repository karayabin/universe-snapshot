...
use Ling\Light_Kit_Editor\Api\Generated\Interfaces\PageHasBlockApiInterface;
 ...
 */
class PageHasBlockApi extends CustomLightKitEditorBaseApi implements PageHasBlockApiInterface
{
    ...
    { 
        ...
        try {
            ...
            $lastInsertId = $this->pdoWrapper->insert($this->table, $pageHasBlock);
            if (false === $returnRic) {
                return $lastInsertId;
            }
            $ric = [
        ...
        if (null !== $errorInfo) {
            if ('23000' === $errorInfo[0]) {
                ...
                $allMarkers = [];
                SimplePdoWrapper::addWhereSubStmt($query, $allMarkers, $pageHasBlock);
    ...
    {
        $ret = [];
        foreach ($pageHasBlocks as $pageHasBlock) {
            $res = $this->insertPageHasBlock($pageHasBlock, $ignoreDuplicate, $returnRic);
            if (false === $res) {
                return false;
            }
            $ret[] = $res;
    ...
    {
        $this->pdoWrapper->update($this->table, $pageHasBlock, array_merge([
            "id" => $id,
    ...
    {
        $this->pdoWrapper->update($this->table, $pageHasBlock, $where, $markers);
    }
