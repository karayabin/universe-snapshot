 ...
 */
interface BlockHasWidgetApiInterface
{
    ...
    /**
     * Returns an array of $key => $value from the blockHasWidget rows identified by the given [where conditions](https://github.com/lingtalfi/SimplePdoWrapper#the-where-conditions).
     *
     *
     * @param string $key
     * @param string $value
    ...
    /**
     * Updates the block has widget row identified by the given id.
     *
     * @param int $id
     * @param array $blockHasWidget
    ...
    /**
     * Updates the block has widget row.
     *
     * @param array $blockHasWidget
     * @param mixed $where
     * @param array $markers
    ...
    /**
     * Deletes the block has widget identified by the given id.
     *
     * @param int $id
     * @return void
     * @throws \Exception
    ...
    /**
     * Deletes the block has widget rows identified by the given ids.
     *
     * @param array $ids
     * @return void
     * @throws \Exception
    ...
    /**
     * Deletes the block has widget rows having the given block id.
     * @param int $blockId
     */
    public function deleteBlockHasWidgetByBlockId(int $blockId);

    /**
     * Deletes the block has widget rows having the given widget id.
     * @param int $widgetId
     */
