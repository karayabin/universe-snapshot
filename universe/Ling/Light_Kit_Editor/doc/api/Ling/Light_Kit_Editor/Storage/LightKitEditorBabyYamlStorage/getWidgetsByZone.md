...
LightKitEditorBabyYamlStorage::getWidgetsByZone
================



LightKitEditorBabyYamlStorage::getWidgetsByZone — Returns the widgets array for the given zone id.
...
private [LightKitEditorBabyYamlStorage::getWidgetsByZone](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/doc/api/Ling/Light_Kit_Editor/Storage/LightKitEditorBabyYamlStorage/getWidgetsByZone.md)(string $zoneId) : array
...
Source Code
===========
See the source code for method [LightKitEditorBabyYamlStorage::getWidgetsByZone](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/Storage/LightKitEditorBabyYamlStorage.php#L128-L136)
