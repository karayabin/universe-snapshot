...
Source Code
===========
See the source code for method [LightKitEditorService::getFactory](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/Service/LightKitEditorService.php#L337-L345)
