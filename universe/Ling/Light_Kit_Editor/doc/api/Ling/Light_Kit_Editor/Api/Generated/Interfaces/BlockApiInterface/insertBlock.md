...
BlockApiInterface::insertBlock
================



BlockApiInterface::insertBlock — Inserts the given block in the database.
...
Source Code
===========
See the source code for method [BlockApiInterface::insertBlock](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/Api/Generated/Interfaces/BlockApiInterface.php#L35-L35)
...
Next method: [insertBlocks](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/doc/api/Ling/Light_Kit_Editor/Api/Generated/Interfaces/BlockApiInterface/insertBlocks.md)<br>
