...
BlockApi::delete — Deletes the block rows matching the given where conditions, and returns the number of deleted rows.
...
Source Code
===========
See the source code for method [BlockApi::delete](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/Api/Generated/Classes/BlockApi.php#L422-L426)
