...
PageHasZoneApi::insertPageHasZones
================



PageHasZoneApi::insertPageHasZones — Inserts the given page has zone rows in the database.
...
Source Code
===========
See the source code for method [PageHasZoneApi::insertPageHasZones](https://github.com/lingtalfi/Light_Kit_Editor/blob/master/Api/Generated/Classes/PageHasZoneApi.php#L100-L111)
