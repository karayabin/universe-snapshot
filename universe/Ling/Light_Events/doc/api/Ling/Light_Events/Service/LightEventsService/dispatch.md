...
Source Code
===========
See the source code for method [LightEventsService::dispatch](https://github.com/lingtalfi/Light_Events/blob/master/Service/LightEventsService.php#L80-L109)
