...
namespace Ling\Light_Events\Light_PlanetInstaller;
 ...
 */
class LightEventsPlanetInstaller extends LightBasePlanetInstaller implements LightPlanetInstallerInit2HookInterface
{
    ...
    public function init2(string $appDir, OutputInterface $output, array $options = []): void
    {
        ...
        $planetDotName = "Ling.Light_Events";
