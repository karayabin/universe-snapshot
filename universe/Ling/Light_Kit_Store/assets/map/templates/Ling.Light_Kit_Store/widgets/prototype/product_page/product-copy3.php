...
<div id="product-main" class="product-main d-flex flex-column flex-lg-row">
    ...
    <?php if ($item['screenshots']):
        ...
        ?>
        <div class="product-photos d-flex order-lg-1 d-lg-none" id="gallery--simple">
    ...
    <div class="buy-buttons d-flex justify-content-between mb-3 d-lg-none">
        <button class="btn btn-add-to-cart ms-2">Add to Cart</button>
        <button class="btn btn-buy-now me-2">Buy Now</button>
    </div>
    ...
    <div class="customer-reviews">
        ...
        <div class="customer-review-items">
            <?php foreach ($item['reviews'] as $item):
                $nbFullStars = (int)$item['rating'];
                ?>
                <div class="customer-review-item">
                    <div class="line1 d-flex align-items-center">
                        ...
                        <a href="#<?php echo $item['id']; ?>"
                           ...
                           class="strong-link no-change user-name"><?php echo $item['rating_name']; ?></a>
                    </div>
                    <div class="line2">
                    ...
                    <div class="comment-title strong-color fw-bold"><?php echo $item['rating_title']; ?></div>


                    <div class="line3">
                        <span class="review-date">Reviewed on <?php echo $item['datetime']; ?></span>
                    </div>
                    <div class="line5">
                        <p class="rating-comment color-strong">
                            <?php
                            $more = false;
                            echo StringTool::cutAtWordBoundary($item['rating_comment'], 250, "...", $more);
                            ?>
    ...
    <div class="product-sidebar order-3 d-none d-lg-block" style="min-width: 250px">
        Product sidebar
    </div>
