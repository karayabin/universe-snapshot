...
/**
 * The AddressApiInterface interface.
...
interface AddressApiInterface
{
    ...
    /**
     * Inserts the given address rows in the database.
    ...
    /**
     * Returns the address row identified by the given id.
     *
    ...
    /**
     * Returns the address row identified by the given [where conditions](https://github.com/lingtalfi/SimplePdoWrapper#the-where-conditions).
     *
     * If the row is not found, this method's return depends on the throwNotFoundEx flag:
     * - if true, the method throws an exception
     * - if false, the method returns the given default value
    ...
    /**
     * Returns the address rows identified by the given [where conditions](https://github.com/lingtalfi/SimplePdoWrapper#the-where-conditions).
     *
     *
     * @param $where
     * @param array $markers
    ...
    /**
     * Returns an array which values are the given $column, from the address rows
    ...
    /**
     * Returns a subset of the address rows identified by the given [where conditions](https://github.com/lingtalfi/SimplePdoWrapper#the-where-conditions).
    ...
    /**
     * Returns an array of $key => $value from the address rows identified by the given [where conditions](https://github.com/lingtalfi/SimplePdoWrapper#the-where-conditions).
     *
     *
     * @param string $key
     * @param string $value
    ...
    /**
     * Returns the rows of the lks_address matching the given userId.
     * The components is an array of [fetch all components](https://github.com/lingtalfi/SimplePdoWrapper/blob/master/doc/pages/fetch-all-components.md).
     *
     * @param string $userId
     * @param array $components
    ...
    /**
     * Returns an array of all address ids.
     *
     * @return array
     * @throws \Exception
     */
    ...
    /**
     * Updates the address row identified by the given id.
     *
     * @param int $id
     * @param array $address
    ...
    /**
     * Deletes the address rows matching the given where conditions, and returns the number of deleted rows.
    ...
    /**
     * Deletes the address rows identified by the given ids.
     *
     * @param array $ids
     * @return void
     * @throws \Exception
    ...
    /**
     * Deletes the address rows having the given user id.
     * @param int $userId
     */
