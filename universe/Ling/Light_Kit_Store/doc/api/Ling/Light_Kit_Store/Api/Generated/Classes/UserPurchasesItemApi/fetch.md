...
UserPurchasesItemApi::fetch
================



UserPurchasesItemApi::fetch — Returns the first row corresponding to given components, or false if there is no match.
...
Source Code
===========
See the source code for method [UserPurchasesItemApi::fetch](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Api/Generated/Classes/UserPurchasesItemApi.php#L133-L143)
