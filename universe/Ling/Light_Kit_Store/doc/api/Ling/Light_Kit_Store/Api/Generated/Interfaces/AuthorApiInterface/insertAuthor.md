...
AuthorApiInterface::insertAuthor
================



AuthorApiInterface::insertAuthor — Inserts the given author in the database.
...
Source Code
===========
See the source code for method [AuthorApiInterface::insertAuthor](https://github.com/lingtalfi/Light_Kit_Store/blob/master/Api/Generated/Interfaces/AuthorApiInterface.php#L35-L35)
...
Next method: [insertAuthors](https://github.com/lingtalfi/Light_Kit_Store/blob/master/doc/api/Ling/Light_Kit_Store/Api/Generated/Interfaces/AuthorApiInterface/insertAuthors.md)<br>
