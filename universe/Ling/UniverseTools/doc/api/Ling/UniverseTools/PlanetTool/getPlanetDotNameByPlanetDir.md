...
PlanetTool::getPlanetDotNameByPlanetDir
================



PlanetTool::getPlanetDotNameByPlanetDir — Returns the planet dot name from the given planet dir.
...
public static [PlanetTool::getPlanetDotNameByPlanetDir](https://github.com/lingtalfi/UniverseTools/blob/master/doc/api/Ling/UniverseTools/PlanetTool/getPlanetDotNameByPlanetDir.md)(string $planetDir) : string
