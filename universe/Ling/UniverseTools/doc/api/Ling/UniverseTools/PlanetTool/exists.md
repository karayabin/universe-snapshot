...
PlanetTool::exists — Returns whether the given planet exists in the given app.
...
public static [PlanetTool::exists](https://github.com/lingtalfi/UniverseTools/blob/master/doc/api/Ling/UniverseTools/PlanetTool/exists.md)(string $planetDotName, string $applicationDir) : bool
