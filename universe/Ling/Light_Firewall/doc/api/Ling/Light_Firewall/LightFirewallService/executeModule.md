...
LightFirewallService::executeModule
================



LightFirewallService::executeModule — Execute the given module.
...
Source Code
===========
See the source code for method [LightFirewallService::executeModule](https://github.com/lingtalfi/Light_Firewall/blob/master/LightFirewallService.php#L82-L91)
...
Previous method: [run](https://github.com/lingtalfi/Light_Firewall/blob/master/doc/api/Ling/Light_Firewall/LightFirewallService/run.md)<br>Next method: [checkDomain](https://github.com/lingtalfi/Light_Firewall/blob/master/doc/api/Ling/Light_Firewall/LightFirewallService/checkDomain.md)<br>
