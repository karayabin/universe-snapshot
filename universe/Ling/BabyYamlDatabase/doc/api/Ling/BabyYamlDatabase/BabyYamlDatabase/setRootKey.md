...
BabyYamlDatabase::setRootKey
================



BabyYamlDatabase::setRootKey — Sets the rootKey.
...
Previous method: [setFile](https://github.com/lingtalfi/BabyYamlDatabase/blob/master/doc/api/Ling/BabyYamlDatabase/BabyYamlDatabase/setFile.md)<br>Next method: [getTableArray](https://github.com/lingtalfi/BabyYamlDatabase/blob/master/doc/api/Ling/BabyYamlDatabase/BabyYamlDatabase/getTableArray.md)<br>
