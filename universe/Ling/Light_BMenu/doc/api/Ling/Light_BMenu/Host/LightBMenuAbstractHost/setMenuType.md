...
LightBMenuAbstractHost::setMenuType
================



LightBMenuAbstractHost::setMenuType — Sets the menu type.
...
public [LightBMenuAbstractHost::setMenuType](https://github.com/lingtalfi/Light_BMenu/blob/master/doc/api/Ling/Light_BMenu/Host/LightBMenuAbstractHost/setMenuType.md)(string $menuType) : void
...
Source Code
===========
See the source code for method [LightBMenuAbstractHost::setMenuType](https://github.com/lingtalfi/Light_BMenu/blob/master/Host/LightBMenuAbstractHost.php#L82-L85)
