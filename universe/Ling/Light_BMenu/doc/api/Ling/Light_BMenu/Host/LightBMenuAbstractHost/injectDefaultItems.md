...
LightBMenuAbstractHost::injectDefaultItems
================



LightBMenuAbstractHost::injectDefaultItems — Inject menu items in the given menu structure.
...
Source Code
===========
See the source code for method [LightBMenuAbstractHost::injectDefaultItems](https://github.com/lingtalfi/Light_BMenu/blob/master/Host/LightBMenuAbstractHost.php#L62-L69)
...
Previous method: [getMenuStructureId](https://github.com/lingtalfi/Light_BMenu/blob/master/doc/api/Ling/Light_BMenu/Host/LightBMenuAbstractHost/getMenuStructureId.md)<br>Next method: [onMenuCompiled](https://github.com/lingtalfi/Light_BMenu/blob/master/doc/api/Ling/Light_BMenu/Host/LightBMenuAbstractHost/onMenuCompiled.md)<br>
