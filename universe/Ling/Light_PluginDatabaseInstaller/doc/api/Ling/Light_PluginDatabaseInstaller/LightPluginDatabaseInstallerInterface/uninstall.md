...
LightPluginDatabaseInstallerInterface::uninstall
================



LightPluginDatabaseInstallerInterface::uninstall — Uninstalls the database part of the light plugin.
...
Source Code
===========
See the source code for method [LightPluginDatabaseInstallerInterface::uninstall](https://github.com/lingtalfi/Light_PluginDatabaseInstaller/blob/master/LightPluginDatabaseInstallerInterface.php#L34-L34)
...
Previous method: [install](https://github.com/lingtalfi/Light_PluginDatabaseInstaller/blob/master/doc/api/Ling/Light_PluginDatabaseInstaller/LightPluginDatabaseInstallerInterface/install.md)<br>
