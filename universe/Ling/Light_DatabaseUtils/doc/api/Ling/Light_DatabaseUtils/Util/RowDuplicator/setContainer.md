...
RowDuplicator::setContainer
================



RowDuplicator::setContainer — Sets the container.
...
Source Code
===========
See the source code for method [RowDuplicator::setContainer](https://github.com/lingtalfi/Light_DatabaseUtils/blob/master/Util/RowDuplicator.php#L47-L50)
...
Previous method: [__construct](https://github.com/lingtalfi/Light_DatabaseUtils/blob/master/doc/api/Ling/Light_DatabaseUtils/Util/RowDuplicator/__construct.md)<br>Next method: [duplicate](https://github.com/lingtalfi/Light_DatabaseUtils/blob/master/doc/api/Ling/Light_DatabaseUtils/Util/RowDuplicator/duplicate.md)<br>
