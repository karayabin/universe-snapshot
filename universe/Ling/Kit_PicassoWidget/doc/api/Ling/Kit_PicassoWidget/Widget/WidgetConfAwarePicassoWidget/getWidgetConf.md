...
WidgetConfAwarePicassoWidget::getWidgetConf
================



WidgetConfAwarePicassoWidget::getWidgetConf — Returns the widget configuration.
...
Previous method: [setWidgetConf](https://github.com/lingtalfi/Kit_PicassoWidget/blob/master/doc/api/Ling/Kit_PicassoWidget/Widget/WidgetConfAwarePicassoWidget/setWidgetConf.md)<br>
