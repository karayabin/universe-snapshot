...
UniToolApplication::checkApplicationDir
================



UniToolApplication::checkApplicationDir — Returns the application directory if it actually exists.
...
public [UniToolApplication::checkApplicationDir](https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Application/UniToolApplication/checkApplicationDir.md)() : string
