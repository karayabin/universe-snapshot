...
public [InitLocalServerCommand::run](https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/InitLocalServerCommand/run.md)(Ling\CliTools\Input\InputInterface $input, Ling\CliTools\Output\OutputInterface $output) : mixed
...
Source Code
===========
See the source code for method [InitLocalServerCommand::run](https://github.com/lingtalfi/Uni2/blob/master/Command/InitLocalServerCommand.php#L28-L58)
