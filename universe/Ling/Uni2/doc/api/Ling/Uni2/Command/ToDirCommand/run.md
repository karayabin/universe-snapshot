...
public [ToDirCommand::run](https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ToDirCommand/run.md)(Ling\CliTools\Input\InputInterface $input, Ling\CliTools\Output\OutputInterface $output) : mixed
...
Source Code
===========
See the source code for method [ToDirCommand::run](https://github.com/lingtalfi/Uni2/blob/master/Command/ToDirCommand.php#L76-L145)
