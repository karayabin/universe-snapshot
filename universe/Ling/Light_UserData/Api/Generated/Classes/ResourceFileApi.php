 ...
 */
class ResourceFileApi extends CustomLightUserDataBaseApi implements ResourceFileApiInterface
{


    /**
     * Builds the ResourceFileApi instance.
     */
    public function __construct()
    {
        parent::__construct();
        $this->table = "luda_resource_file";
    }
     ...
     * @implementation
     */
    public function insertResourceFile(array $resourceFile, bool $ignoreDuplicate = true, bool $returnRic = false)
    { 
        ...
        try {
            ...
            $lastInsertId = $this->pdoWrapper->insert($this->table, $resourceFile);
            if (false === $returnRic) {
                return $lastInsertId;
            }
            $ric = [
        ...
        if (null !== $errorInfo) {
            if ('23000' === $errorInfo[0]) {
                ...
                $allMarkers = [];
                SimplePdoWrapper::addWhereSubStmt($query, $allMarkers, $resourceFile);
     ...
     * @implementation
     */
    public function insertResourceFiles(array $resourceFiles, bool $ignoreDuplicate = true, bool $returnRic = false)
    {
        $ret = [];
        foreach ($resourceFiles as $resourceFile) {
            $res = $this->insertResourceFile($resourceFile, $ignoreDuplicate, $returnRic);
            if (false === $res) {
                return false;
            }
            $ret[] = $res;
     ...
     * @implementation
     */
    public function getResourceFileById(int $id, $default = null, bool $throwNotFoundEx = false)
    {
     ...
     * @implementation
     */
    public function getResourceFile($where, array $markers = [], $default = null, bool $throwNotFoundEx = false)
    {
     ...
     * @implementation
     */
    public function getResourceFiles($where, array $markers = [])
    {
        $q = "select * from `$this->table`";
        SimplePdoWrapper::addWhereSubStmt($q, $markers, $where);
     ...
     * @implementation
     */
    public function getResourceFilesColumn(string $column, $where, array $markers = [])
    {
     ...
     * @implementation
     */
    public function getResourceFilesColumns($columns, $where, array $markers = [])
    {
        $sCols = $columns;
        if (is_array($sCols)) {
     ...
     * @implementation
     */
    public function getResourceFilesKey2Value(string $key, string $value, $where, array $markers = [])
    {
     ...
     * @implementation
     */
    public function updateResourceFileById(int $id, array $resourceFile, array $extraWhere = [], array $markers = [])
    {
        $this->pdoWrapper->update($this->table, $resourceFile, array_merge([
            "id" => $id,
     ...
     * @implementation
     */
    public function updateResourceFile(array $resourceFile, $where = null, array $markers = [])
    {
        $this->pdoWrapper->update($this->table, $resourceFile, $where, $markers);
    }
     ...
     * @implementation
     */
    public function deleteResourceFileById(int $id)
    {
     ...
     * @implementation
     */
    public function deleteResourceFileByIds(array $ids)
    {
     ...
     * @implementation
     */
    public function deleteResourceFileByLudaResourceId(int $resourceId)
    {
        $this->pdoWrapper->delete($this->table, [
