...
ResourceApiInterface::getResourceInfoByResourceIdentifier
================



ResourceApiInterface::getResourceInfoByResourceIdentifier — Returns the resource info identified by the given resource_identifier.
...
Source Code
===========
See the source code for method [ResourceApiInterface::getResourceInfoByResourceIdentifier](https://github.com/lingtalfi/Light_UserData/blob/master/Api/Interfaces/ResourceApiInterface.php#L192-L192)
...
Previous method: [deleteResourceByResourceIdentifier](https://github.com/lingtalfi/Light_UserData/blob/master/doc/api/Ling/Light_UserData/Api/Interfaces/ResourceApiInterface/deleteResourceByResourceIdentifier.md)<br>
