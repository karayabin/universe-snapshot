...
Source Code
===========
See the source code for method [LightUserDataService::install](https://github.com/lingtalfi/Light_UserData/blob/master/Service/LightUserDataService.php#L131-L216)
