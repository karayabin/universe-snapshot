...
Source Code
===========
See the source code for method [LightDbSynchronizerService::getMysqlStructureReader](https://github.com/lingtalfi/Light_DbSynchronizer/blob/master/Service/LightDbSynchronizerService.php#L809-L815)
