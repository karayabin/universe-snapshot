...
BabyYamlLightUserDatabase::updateUser
================



BabyYamlLightUserDatabase::updateUser — Updates the user identified by the given identifier.
...
public [BabyYamlLightUserDatabase::updateUser](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/BabyYamlLightUserDatabase/updateUser.md)(string $identifier, array $userInfo) : void
