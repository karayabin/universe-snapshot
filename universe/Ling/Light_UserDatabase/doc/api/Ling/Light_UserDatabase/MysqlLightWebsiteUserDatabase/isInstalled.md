...
MysqlLightWebsiteUserDatabase::isInstalled
================



MysqlLightWebsiteUserDatabase::isInstalled — Returns whether the core install phase of the plugin is fully completed.
