...
PermissionGroupApi::getPermissionGroupNamesByUserIdentifier
================



PermissionGroupApi::getPermissionGroupNamesByUserIdentifier — Returns an array of lud_permission_group.name bound to the given user identifier.
...
Source Code
===========
See the source code for method [PermissionGroupApi::getPermissionGroupNamesByUserIdentifier](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Classes/PermissionGroupApi.php#L297-L307)
