...
PermissionApi::fetch — Returns the first row corresponding to given components, or false if there is no match.
...
Source Code
===========
See the source code for method [PermissionApi::fetch](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Classes/PermissionApi.php#L129-L139)
