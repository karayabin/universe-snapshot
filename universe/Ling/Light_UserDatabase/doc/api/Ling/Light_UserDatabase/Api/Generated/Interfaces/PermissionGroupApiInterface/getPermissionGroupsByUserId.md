...
PermissionGroupApiInterface::getPermissionGroupsByUserId
================



PermissionGroupApiInterface::getPermissionGroupsByUserId — Returns the rows of the lud_permission_group table bound to the given user id.
...
Source Code
===========
See the source code for method [PermissionGroupApiInterface::getPermissionGroupsByUserId](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Interfaces/PermissionGroupApiInterface.php#L168-L168)
