...
MysqlBaseLightUserDatabaseApi::checkMicroPermission
================



MysqlBaseLightUserDatabaseApi::checkMicroPermission — Checks whether the current user has the micro permission which type is specified.
...
Source Code
===========
See the source code for method [MysqlBaseLightUserDatabaseApi::checkMicroPermission](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Mysql/MysqlBaseLightUserDatabaseApi.php#L86-L96)
...
Previous method: [setContainer](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Api/Mysql/MysqlBaseLightUserDatabaseApi/setContainer.md)<br>
