...
PermissionGroupApi::getPermissionGroupIdsByUserIdentifier — Returns an array of lud_permission_group.id bound to the given user identifier.
...
Source Code
===========
See the source code for method [PermissionGroupApi::getPermissionGroupIdsByUserIdentifier](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Classes/PermissionGroupApi.php#L297-L307)
