...
PermissionGroupApi::getPermissionGroupNamesByPermissionName
================



PermissionGroupApi::getPermissionGroupNamesByPermissionName — Returns an array of lud_permission_group.name bound to the given permission name.
...
Source Code
===========
See the source code for method [PermissionGroupApi::getPermissionGroupNamesByPermissionName](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Classes/PermissionGroupApi.php#L363-L373)
