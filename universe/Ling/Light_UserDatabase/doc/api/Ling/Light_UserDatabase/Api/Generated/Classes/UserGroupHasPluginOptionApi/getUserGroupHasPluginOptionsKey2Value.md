...
UserGroupHasPluginOptionApi::getUserGroupHasPluginOptionsKey2Value
================



UserGroupHasPluginOptionApi::getUserGroupHasPluginOptionsKey2Value — Returns an array of $key => $value from the userGroupHasPluginOption rows identified by the given [where conditions](https://github.com/lingtalfi/SimplePdoWrapper#the-where-conditions).
...
Source Code
===========
See the source code for method [UserGroupHasPluginOptionApi::getUserGroupHasPluginOptionsKey2Value](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Classes/UserGroupHasPluginOptionApi.php#L196-L201)
