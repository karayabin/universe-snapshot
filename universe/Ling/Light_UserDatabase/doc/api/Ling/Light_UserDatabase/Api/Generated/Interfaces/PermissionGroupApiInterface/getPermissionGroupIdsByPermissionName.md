...
PermissionGroupApiInterface::getPermissionGroupIdsByPermissionName
================



PermissionGroupApiInterface::getPermissionGroupIdsByPermissionName — Returns an array of lud_permission_group.id bound to the given permission name.
...
Source Code
===========
See the source code for method [PermissionGroupApiInterface::getPermissionGroupIdsByPermissionName](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Interfaces/PermissionGroupApiInterface.php#L237-L237)
