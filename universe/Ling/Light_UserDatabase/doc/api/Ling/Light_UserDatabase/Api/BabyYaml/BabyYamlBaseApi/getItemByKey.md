...
BabyYamlBaseApi::getItemByKey
================



BabyYamlBaseApi::getItemByKey — Returns the first row matching the given key.
...
Source Code
===========
See the source code for method [BabyYamlBaseApi::getItemByKey](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/BabyYaml/BabyYamlBaseApi.php#L123-L136)
...
Previous method: [getBabyYamlDatabase](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Api/BabyYaml/BabyYamlBaseApi/getBabyYamlDatabase.md)<br>Next method: [insertItem](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Api/BabyYaml/BabyYamlBaseApi/insertItem.md)<br>
