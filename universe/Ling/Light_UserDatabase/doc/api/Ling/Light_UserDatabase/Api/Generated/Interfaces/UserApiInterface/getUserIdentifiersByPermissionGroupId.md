...
UserApiInterface::getUserIdentifiersByPermissionGroupId
================



UserApiInterface::getUserIdentifiersByPermissionGroupId — Returns an array of lud_user.identifier bound to the given permission_group id.
...
Source Code
===========
See the source code for method [UserApiInterface::getUserIdentifiersByPermissionGroupId](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Generated/Interfaces/UserApiInterface.php#L200-L200)
