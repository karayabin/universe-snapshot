...
MysqlPermissionGroupApi::__construct — Builds the PermissionGroupApi instance.
...
Source Code
===========
See the source code for method [MysqlPermissionGroupApi::__construct](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Mysql/MysqlPermissionGroupApi.php#L25-L28)
