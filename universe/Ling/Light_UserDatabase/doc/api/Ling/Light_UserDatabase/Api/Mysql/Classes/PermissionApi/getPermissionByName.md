...
Source Code
===========
See the source code for method [PermissionApi::getPermissionByName](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Api/Mysql/Classes/PermissionApi.php#L96-L110)
