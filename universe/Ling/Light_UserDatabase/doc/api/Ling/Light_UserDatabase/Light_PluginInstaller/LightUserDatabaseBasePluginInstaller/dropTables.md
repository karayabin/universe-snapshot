...
LightUserDatabaseBasePluginInstaller::dropTables
================



LightUserDatabaseBasePluginInstaller::dropTables — Drop the given tables, if they exist.
...
Previous method: [removeLightStandardPermissions](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/removeLightStandardPermissions.md)<br>Next method: [hasTable](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/hasTable.md)<br>
