...
LightUserDatabaseBasePluginInstaller::message
================



LightUserDatabaseBasePluginInstaller::message — Writes a message to the channel of the plugin installer planet.
...
Source Code
===========
See the source code for method [LightUserDatabaseBasePluginInstaller::message](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller.php#L250-L262)
...
Previous method: [warningMsg](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/warningMsg.md)<br>Next method: [synchronizeDatabase](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/synchronizeDatabase.md)<br>
