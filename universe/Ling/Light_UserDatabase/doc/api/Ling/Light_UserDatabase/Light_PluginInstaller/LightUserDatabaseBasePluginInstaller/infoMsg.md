...
LightUserDatabaseBasePluginInstaller::infoMsg
================



LightUserDatabaseBasePluginInstaller::infoMsg — Writes a message to the info channel of the plugin installer planet.
...
Source Code
===========
See the source code for method [LightUserDatabaseBasePluginInstaller::infoMsg](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller.php#L225-L228)
...
Previous method: [debugMsg](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/debugMsg.md)<br>Next method: [warningMsg](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/warningMsg.md)<br>
