...
LightUserDatabaseBasePluginInstaller::synchronizeDatabase
================



LightUserDatabaseBasePluginInstaller::synchronizeDatabase — Synchronizes the database with the create file (if any) of this planet.
...
Previous method: [message](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/message.md)<br>Next method: [extractPlanetDotName](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/extractPlanetDotName.md)<br>
