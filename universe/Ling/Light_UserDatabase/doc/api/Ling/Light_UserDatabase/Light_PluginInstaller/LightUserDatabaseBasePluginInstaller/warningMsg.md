...
LightUserDatabaseBasePluginInstaller::warningMsg
================



LightUserDatabaseBasePluginInstaller::warningMsg — Writes a message to the warning channel of the plugin installer planet.
...
Source Code
===========
See the source code for method [LightUserDatabaseBasePluginInstaller::warningMsg](https://github.com/lingtalfi/Light_UserDatabase/blob/master/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller.php#L240-L243)
...
Previous method: [infoMsg](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/infoMsg.md)<br>Next method: [message](https://github.com/lingtalfi/Light_UserDatabase/blob/master/doc/api/Ling/Light_UserDatabase/Light_PluginInstaller/LightUserDatabaseBasePluginInstaller/message.md)<br>
