...
MethodCallResolver::setContainer
================



MethodCallResolver::setContainer — Sets the container.
...
Source Code
===========
See the source code for method [MethodCallResolver::setContainer](https://github.com/lingtalfi/Light_Kit/blob/master/PageConfigurationTransformer/LazyReferenceResolver/MethodCallResolver.php#L55-L58)
...
Previous method: [resolve](https://github.com/lingtalfi/Light_Kit/blob/master/doc/api/Ling/Light_Kit/PageConfigurationTransformer/LazyReferenceResolver/MethodCallResolver/resolve.md)<br>
