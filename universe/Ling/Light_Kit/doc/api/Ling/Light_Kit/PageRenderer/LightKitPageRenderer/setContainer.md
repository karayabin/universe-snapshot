...
Source Code
===========
See the source code for method [LightKitPageRenderer::setContainer](https://github.com/lingtalfi/Light_Kit/blob/master/PageRenderer/LightKitPageRenderer.php#L87-L90)
