...
LightControllerHubPlanetInstaller::init2
================



LightControllerHubPlanetInstaller::init2 — Executes the init 2 phase of the install command.
...
Source Code
===========
See the source code for method [LightControllerHubPlanetInstaller::init2](https://github.com/lingtalfi/Light_ControllerHub/blob/master/Light_PlanetInstaller/LightControllerHubPlanetInstaller.php#L23-L30)
...
Next method: [undoInit2](https://github.com/lingtalfi/Light_ControllerHub/blob/master/doc/api/Ling/Light_ControllerHub/Light_PlanetInstaller/LightControllerHubPlanetInstaller/undoInit2.md)<br>
