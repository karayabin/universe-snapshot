...
Source Code
===========
See the source code for method [GenerateBreezeBaseProcess::getTablePrefixes](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/WebWizardTools/Process/Generators/GenerateBreezeBaseProcess.php#L151-L163)
