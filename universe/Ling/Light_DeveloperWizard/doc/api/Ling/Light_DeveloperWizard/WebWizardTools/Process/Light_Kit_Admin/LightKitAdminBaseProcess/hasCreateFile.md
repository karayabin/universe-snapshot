...
LightKitAdminBaseProcess::hasCreateFile
================



LightKitAdminBaseProcess::hasCreateFile — Checks that the create file exists for the current planet, and adds a disabled reason error if that's not the case.
...
Source Code
===========
See the source code for method [LightKitAdminBaseProcess::hasCreateFile](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/WebWizardTools/Process/Light_Kit_Admin/LightKitAdminBaseProcess.php#L101-L111)
...
Previous method: [hostPlanetHasCreateFile](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Kit_Admin/LightKitAdminBaseProcess/hostPlanetHasCreateFile.md)<br>Next method: [generateLkaPlanet](https://github.com/lingtalfi/Light_DeveloperWizard/blob/master/doc/api/Ling/Light_DeveloperWizard/WebWizardTools/Process/Light_Kit_Admin/LightKitAdminBaseProcess/generateLkaPlanet.md)<br>
