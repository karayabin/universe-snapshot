...
Source Code
===========
See the source code for method [TokenArrayIteratorTool::skipUntil](https://github.com/lingtalfi/TokenFun/blob/master/TokenArrayIterator/Tool/TokenArrayIteratorTool.php#L375-L393)
