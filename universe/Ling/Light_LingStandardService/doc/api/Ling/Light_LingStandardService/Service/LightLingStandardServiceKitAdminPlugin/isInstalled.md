...
LightLingStandardServiceKitAdminPlugin::isInstalled
================



LightLingStandardServiceKitAdminPlugin::isInstalled — Returns whether the core install phase of the plugin is fully completed.
...
public [LightLingStandardServiceKitAdminPlugin::isInstalled](https://github.com/lingtalfi/Light_LingStandardService/blob/master/doc/api/Ling/Light_LingStandardService/Service/LightLingStandardServiceKitAdminPlugin/isInstalled.md)() : bool
