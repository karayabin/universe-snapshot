...
LightLingStandardServiceKitAdminPlugin::install
================



LightLingStandardServiceKitAdminPlugin::install — Installs the plugin in the light application.
...
public [LightLingStandardServiceKitAdminPlugin::install](https://github.com/lingtalfi/Light_LingStandardService/blob/master/doc/api/Ling/Light_LingStandardService/Service/LightLingStandardServiceKitAdminPlugin/install.md)() : void
...
Previous method: [setOptions](https://github.com/lingtalfi/Light_LingStandardService/blob/master/doc/api/Ling/Light_LingStandardService/Service/LightLingStandardServiceKitAdminPlugin/setOptions.md)<br>Next method: [isInstalled](https://github.com/lingtalfi/Light_LingStandardService/blob/master/doc/api/Ling/Light_LingStandardService/Service/LightLingStandardServiceKitAdminPlugin/isInstalled.md)<br>
