...
BaseConfigGenerator::getTableInfo
================



BaseConfigGenerator::getTableInfo — Returns the tableInfo array, either from the createFile, or from the database, depending on the configuration.
