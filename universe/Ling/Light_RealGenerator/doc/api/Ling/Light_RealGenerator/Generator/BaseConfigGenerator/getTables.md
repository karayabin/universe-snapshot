...
Source Code
===========
See the source code for method [BaseConfigGenerator::getTables](https://github.com/lingtalfi/Light_RealGenerator/blob/master/Generator/BaseConfigGenerator.php#L66-L101)
