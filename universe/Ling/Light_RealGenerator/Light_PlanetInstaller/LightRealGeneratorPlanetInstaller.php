...
namespace Ling\Light_RealGenerator\Light_PlanetInstaller;
 ...
 */
class LightRealGeneratorPlanetInstaller extends LightBasePlanetInstaller implements LightPlanetInstallerInit2HookInterface
{
    ...
    public function init2(string $appDir, OutputInterface $output, array $options = []): void
    {
        ...
        $planetDotName = "Ling.Light_ErrorHandler";
