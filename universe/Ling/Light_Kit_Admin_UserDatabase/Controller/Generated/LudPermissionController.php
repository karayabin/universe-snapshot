...
class LudPermissionController extends RealAdminPageController
{
    ...
    public function renderList()
    {
        ...
        return $this->renderAdminPage('Ling.Light_Kit_Admin_UserDatabase/generated/lud_permission_list', [
            'widgetVariables' => [
                "body.light_realist" => [
                    'request_declaration_id' => 'Ling.Light_Kit_Admin_UserDatabase:generated/lud_permission',
                ],
            ],
        ]);
    }
    ...
    {
        $realformId = "Ling.Light_Kit_Admin_UserDatabase:generated/lud_permission";
        $nugget = [];
        ...
        return $this->renderAdminPage('Ling.Light_Kit_Admin_UserDatabase/generated/lud_permission_form', [
            'widgetVariables' => [
