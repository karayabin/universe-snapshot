...
namespace Ling\LingTalfi\DocBuilder\Light_UploadGems;
 ...
 */
class Light_UploadGemsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_UploadGems";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_UploadGems";
