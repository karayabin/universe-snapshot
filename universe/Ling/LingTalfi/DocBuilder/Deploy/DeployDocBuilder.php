...
namespace Ling\LingTalfi\DocBuilder\Deploy;
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "configuration file" => $git . '/README.md#the-configuration-file',
                "configuration of the project" => $git . '/README.md#the-configuration-file',
                "map conf configuration" => $git . '/README.md#the-configuration-file',
                "backup files" => $git . '/README.md#the-deploy-directory-in-the-application',
                "database backup files" => $git . '/README.md#the-deploy-directory-in-the-application',
                "diff" => $git . '/README.md#the-general-implementation-behind-files-synchronization',
                "universe" => 'https://github.com/karayabin/universe-snapshot',
                "uni tool" => 'https://github.com/lingtalfi/universe-naive-importer',
                "DiffCommand" => $api . '/Ling/Deploy/Command/DiffCommand.md',
                "CreateMapCommand" => $api . '/Ling/Deploy/Command/CreateMapCommand.md',
            ],
            /**
             ...
             */
            "externalClass2Url" => [
                "Ling\Bat\Exception\BatException" => "https://github.com/lingtalfi/Bat/blob/master/Exception/BatException.php",
