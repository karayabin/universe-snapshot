...
namespace Ling\LingTalfi\DocBuilder\WebWizardTools;
 ...
 */
class WebWizardToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/WebWizardTools";
        $gitRepoUrl = "https://github.com/lingtalfi/WebWizardTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "WebWizardTools conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
