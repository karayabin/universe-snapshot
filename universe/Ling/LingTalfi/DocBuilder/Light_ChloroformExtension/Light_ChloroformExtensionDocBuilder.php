...
namespace Ling\LingTalfi\DocBuilder\Light_ChloroformExtension;
 ...
 */
class Light_ChloroformExtensionDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ChloroformExtension";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ChloroformExtension";
...
//                    "doctool-markup-language.md",
            ...
            "externalClass2Url" => [
                ...
                "Ling\Chloroform\Field\SelectField" => "https://github.com/lingtalfi/Chloroform/blob/master/doc/api/Ling/Chloroform/Field/SelectField.md",
