...
namespace Ling\LingTalfi\DocBuilder\Light_Crud;
...
class Light_CrudDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Crud";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Crud";
...
//                    "doctool-markup-language.md",
            ...
            "keyWord2UrlMap" => [
                ...
                "the multiplier form trick for more details" =>  'https://github.com/lingtalfi/TheBar/blob/master/discussions/form-multiplier.md',
