...
namespace Ling\LingTalfi\DocBuilder\WiseTool;
...
class WiseToolDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/WiseTool";
        $gitRepoUrl = "https://github.com/lingtalfi/WiseTool";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Chloroform notification classes" => "https://github.com/lingtalfi/Chloroform/blob/master/doc/pages/chloroform-array.md",
            ],
            /**
