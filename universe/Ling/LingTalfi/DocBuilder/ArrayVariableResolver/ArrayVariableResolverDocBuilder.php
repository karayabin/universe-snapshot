...
namespace Ling\LingTalfi\DocBuilder\ArrayVariableResolver;
 ...
 */
class ArrayVariableResolverDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ArrayVariableResolver";
        $git = "https://github.com/lingtalfi/ArrayVariableResolver/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
