...
namespace Ling\LingTalfi\DocBuilder\TokenFun;
...
class TokenFunDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/TokenFun";
        $gitRepoUrl = "https://github.com/lingtalfi/TokenFun";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "TokenFun conception notes" => $doc . '/pages/conception-notes.md',
                "tokenProp" => $doc . '/pages/conception-notes.md#tokenprop',
                "tokenProp definition" => $doc . '/pages/conception-notes.md#tokenprop',
            ],
            /**
