...
namespace Ling\LingTalfi\DocBuilder\Light_UserNotifications;
 ...
 */
class Light_UserNotificationsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_UserNotifications";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_UserNotifications";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_UserNotifications conception notes" => $doc . '/pages/conception-notes.md',
