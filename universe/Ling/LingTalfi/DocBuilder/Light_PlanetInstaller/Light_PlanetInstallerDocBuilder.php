...
namespace Ling\LingTalfi\DocBuilder\Light_PlanetInstaller;
 ...
 */
class Light_PlanetInstallerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PlanetInstaller";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PlanetInstaller";
