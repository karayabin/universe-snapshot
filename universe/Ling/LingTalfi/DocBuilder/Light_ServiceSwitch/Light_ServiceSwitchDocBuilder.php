...
namespace Ling\LingTalfi\DocBuilder\Light_ServiceSwitch;
 ...
 */
class Light_ServiceSwitchDocBuilder
{


    /**
     * Launch this function to generate the documentation for the Light_ServiceSwitch planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/Light_ServiceSwitch/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ServiceSwitch";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ServiceSwitch";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_ServiceSwitch conception notes" => $conception,
            ],
            /**
