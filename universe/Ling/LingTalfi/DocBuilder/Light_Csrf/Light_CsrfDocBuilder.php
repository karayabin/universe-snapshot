...
namespace Ling\LingTalfi\DocBuilder\Light_Csrf;
...
class Light_CsrfDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Csrf";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Csrf";
...
//                    "doctool-markup-language.md",
             ...
             */
            "externalClass2Url" => [
                "Ling\CSRFTools\CSRFProtector" => "https://github.com/lingtalfi/CSRFTools/blob/master/doc/api/Ling/CSRFTools/CSRFProtector.md",
            ],
        ];
