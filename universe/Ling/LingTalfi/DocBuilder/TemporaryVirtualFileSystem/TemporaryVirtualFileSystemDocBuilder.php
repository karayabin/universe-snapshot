...
namespace Ling\LingTalfi\DocBuilder\TemporaryVirtualFileSystem;
 ...
 */
class TemporaryVirtualFileSystemDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/TemporaryVirtualFileSystem";
        $gitRepoUrl = "https://github.com/lingtalfi/TemporaryVirtualFileSystem";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "TemporaryVirtualFileSystem conception notes" => $doc . '/pages/conception-notes.md',
                "temporary virtual file system conception notes" => $doc . '/pages/conception-notes.md',
