...
namespace Ling\LingTalfi\DocBuilder\Light_EndRoutine;
 ...
 */
class Light_EndRoutineDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_EndRoutine";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_EndRoutine";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "light route" => 'https://github.com/lingtalfi/Light/blob/master/personal/mydoc/pages/route.md',
            ],
            /**
