...
namespace Ling\LingTalfi\DocBuilder\StripeTools;
...
class StripeToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/StripeTools";
        $gitRepoUrl = "https://github.com/lingtalfi/StripeTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "StripeTools conception notes" => $conception,
            ],
            /**
