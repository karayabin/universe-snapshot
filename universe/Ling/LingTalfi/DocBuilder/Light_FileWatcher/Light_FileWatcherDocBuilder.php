...
namespace Ling\LingTalfi\DocBuilder\Light_FileWatcher;
 ...
 */
class Light_FileWatcherDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_FileWatcher";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_FileWatcher";
