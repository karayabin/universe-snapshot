...
namespace Ling\LingTalfi\DocBuilder\Light_PluginDatabaseInstaller;
 ...
 */
class Light_PluginDatabaseInstallerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PluginDatabaseInstaller";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PluginDatabaseInstaller";
