...
namespace Ling\LingTalfi\DocBuilder\SqlWizard;
...
class SqlWizardDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/SqlWizard";
        $gitRepoUrl = "https://github.com/lingtalfi/SqlWizard";
...
//                    "doctool-markup-language.md",
             ...
             */
            "externalClass2Url" => [
                "Ling\SimplePdoWrapper\Exception\InvalidTableNameException" => "https://github.com/lingtalfi/SimplePdoWrapper/blob/master/doc/api/Ling/SimplePdoWrapper/Exception/InvalidTableNameException.md",
            ],
        ];
