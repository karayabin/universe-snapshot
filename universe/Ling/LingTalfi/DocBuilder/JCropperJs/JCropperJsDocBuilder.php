...
namespace Ling\LingTalfi\DocBuilder\JCropperJs;
...
class JCropperJsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JCropperJs";
        $gitRepoUrl = "https://github.com/lingtalfi/JCropperJs";
