...
namespace Ling\LingTalfi\DocBuilder\Light_TablePrefixInfo;
 ...
 */
class Light_TablePrefixInfoDocBuilder
{


    /**
     * Launch this function to generate the documentation for the Light_TablePrefixInfo planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/Light_TablePrefixInfo/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_TablePrefixInfo";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_TablePrefixInfo";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_TablePrefixInfo conception notes" => $conception,
            ],
            /**
