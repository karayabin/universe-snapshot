...
namespace Ling\LingTalfi\DocBuilder\Kwin;
...
class KwinDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Kwin";
        $gitRepoUrl = "https://github.com/lingtalfi/Kwin";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Kwin conception notes" => $conception,
