...
namespace Ling\LingTalfi\DocBuilder\ParentChild;
...
class ParentChildDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ParentChild";
        $gitRepoUrl = "https://github.com/lingtalfi/ParentChild";
