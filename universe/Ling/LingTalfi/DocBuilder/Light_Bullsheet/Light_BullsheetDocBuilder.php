...
namespace Ling\LingTalfi\DocBuilder\Light_Bullsheet;
 ...
 */
class Light_BullsheetDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Bullsheet";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Bullsheet";
