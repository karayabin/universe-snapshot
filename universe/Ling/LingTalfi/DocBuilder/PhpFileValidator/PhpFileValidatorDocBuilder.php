...
namespace Ling\LingTalfi\DocBuilder\PhpFileValidator;
 ...
 */
class PhpFileValidatorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/PhpFileValidator";
        $gitRepoUrl = "https://github.com/lingtalfi/PhpFileValidator";
