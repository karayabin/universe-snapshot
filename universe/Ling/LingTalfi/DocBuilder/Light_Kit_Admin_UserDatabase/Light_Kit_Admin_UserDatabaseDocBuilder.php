...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_Admin_UserDatabase;
 ...
 */
class Light_Kit_Admin_UserDatabaseDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_Admin_UserDatabase";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Kit_Admin_UserDatabase conception notes" => $doc . '/pages/conception-notes.md',
