...
namespace Ling\LingTalfi\DocBuilder\Light_ErrorPop;
...
class Light_ErrorPopDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ErrorPop";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ErrorPop";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_ErrorPop conception notes" => $doc . '/pages/conception-notes.md',
