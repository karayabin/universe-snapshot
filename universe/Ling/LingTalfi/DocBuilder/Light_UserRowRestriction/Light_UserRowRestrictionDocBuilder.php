...
namespace Ling\LingTalfi\DocBuilder\Light_UserRowRestriction;
 ...
 */
class Light_UserRowRestrictionDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_UserRowRestriction";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_UserRowRestriction";
...
//                    "doctool-markup-language.md",
            ...
            "keyWord2UrlMap" => [
                ...
                "the Light_UserRowRestriction conception notes" => $doc . "/pages/conception-notes.md",
            ],
            /**
