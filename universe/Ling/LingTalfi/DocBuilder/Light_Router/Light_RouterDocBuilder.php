...
namespace Ling\LingTalfi\DocBuilder\Light_Router;
...
class Light_RouterDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Router";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Router";
...
//                    "doctool-markup-language.md",
             ...
             */
            "externalClass2Url" => [
                "Ling\Light\Router\LightRouter" => "https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/Router/LightRouter.md",
                "Ling\Light\Router\LightRouterInterface" => "https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/Router/LightRouterInterface.md",
            ],
        ];
