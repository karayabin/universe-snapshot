...
namespace Ling\LingTalfi\DocBuilder\Light_ProjectVars;
 ...
 */
class Light_ProjectVarsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ProjectVars";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ProjectVars";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_ProjectVars conception notes" => $conception,
            ],
            /**
