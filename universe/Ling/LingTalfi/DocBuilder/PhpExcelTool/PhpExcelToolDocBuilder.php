...
namespace Ling\LingTalfi\DocBuilder\PhpExcelTool;
...
class PhpExcelToolDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/PhpExcelTool";
        $gitRepoUrl = "https://github.com/lingtalfi/PhpExcelTool";
