...
namespace Ling\LingTalfi\DocBuilder\JPostForm;
...
class JPostFormDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JPostForm";
        $gitRepoUrl = "https://github.com/lingtalfi/JPostForm";
