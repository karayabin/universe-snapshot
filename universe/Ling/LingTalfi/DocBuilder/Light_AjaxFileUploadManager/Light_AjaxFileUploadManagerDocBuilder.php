...
namespace Ling\LingTalfi\DocBuilder\Light_AjaxFileUploadManager;
 ...
 */
class Light_AjaxFileUploadManagerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_AjaxFileUploadManager";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_AjaxFileUploadManager";
