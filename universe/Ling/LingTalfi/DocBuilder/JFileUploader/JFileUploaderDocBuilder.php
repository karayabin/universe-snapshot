...
namespace Ling\LingTalfi\DocBuilder\JFileUploader;
...
class JFileUploaderDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JFileUploader";
        $gitRepoUrl = "https://github.com/lingtalfi/JFileUploader";
