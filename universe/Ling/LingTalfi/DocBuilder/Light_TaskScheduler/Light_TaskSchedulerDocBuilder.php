...
namespace Ling\LingTalfi\DocBuilder\Light_TaskScheduler;
 ...
 */
class Light_TaskSchedulerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_TaskScheduler";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_TaskScheduler";
