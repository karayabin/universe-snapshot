...
namespace Ling\LingTalfi\DocBuilder\HtmlPageTools;
...
class HtmlPageToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/HtmlPageTools";
        $git = "https://github.com/lingtalfi/HtmlPageTools/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
