...
namespace Ling\LingTalfi\DocBuilder\Light_AppBoilerplate;
 ...
 */
class Light_AppBoilerplateDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_AppBoilerplate";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_AppBoilerplate";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_AppBoilerplate conception notes" => $conception,
            ],
            /**
