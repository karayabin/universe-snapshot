...
namespace Ling\LingTalfi\DocBuilder\JSelectHide;
...
class JSelectHideDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JSelectHide";
        $gitRepoUrl = "https://github.com/lingtalfi/JSelectHide";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JSelectHide conception notes" => $conception,
            ],
            /**
