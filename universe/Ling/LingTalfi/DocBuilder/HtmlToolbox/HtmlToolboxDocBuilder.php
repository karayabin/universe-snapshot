...
namespace Ling\LingTalfi\DocBuilder\HtmlToolbox;
...
class HtmlToolboxDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/HtmlToolbox";
        $gitRepoUrl = "https://github.com/lingtalfi/HtmlToolbox";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "HtmlToolbox conception notes" => $conception,
            ],
            /**
