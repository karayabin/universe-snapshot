...
namespace Ling\LingTalfi\DocBuilder\Light_BreezeGenerator;
 ...
 */
class Light_BreezeGeneratorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_BreezeGenerator";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_BreezeGenerator";
...
//                    "doctool-markup-language.md",
            ...
            "keyWord2UrlMap" => [
                ...
                "ling-breeze-generator-2.md" => 'https://github.com/lingtalfi/Light_BreezeGenerator/blob/master/doc/pages/ling-breeze-generator-2.md',
            ],
            /**
