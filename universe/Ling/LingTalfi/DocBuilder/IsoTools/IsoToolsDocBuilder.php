...
namespace Ling\LingTalfi\DocBuilder\IsoTools;
...
class IsoToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/IsoTools";
        $gitRepoUrl = "https://github.com/lingtalfi/IsoTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "IsoTools conception notes" => $conception,
            ],
            /**
