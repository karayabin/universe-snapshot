...
namespace Ling\LingTalfi\DocBuilder\Light_Cli;
...
class Light_CliDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Cli";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Cli";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Cli conception notes" => $conception,
            ],
            /**
