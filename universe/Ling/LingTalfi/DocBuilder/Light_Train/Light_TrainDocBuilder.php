...
namespace Ling\LingTalfi\DocBuilder\Light_Train;
...
class Light_TrainDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Train";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Train";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Train conception notes" => $conception,
            ],
            /**
