...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_JimToolbox_LingTools;
 ...
 */
class Light_Kit_JimToolbox_LingToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_JimToolbox_LingTools";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_JimToolbox_LingTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Kit_JimToolbox_LingTools conception notes" => $conception,
