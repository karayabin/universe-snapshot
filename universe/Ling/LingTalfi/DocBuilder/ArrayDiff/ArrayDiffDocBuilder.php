...
namespace Ling\LingTalfi\DocBuilder\ArrayDiff;
...
class ArrayDiffDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ArrayDiff";
        $gitRepoUrl = "https://github.com/lingtalfi/ArrayDiff";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "ArrayDiff conception notes" => $doc . '/pages/conception-notes.md',
