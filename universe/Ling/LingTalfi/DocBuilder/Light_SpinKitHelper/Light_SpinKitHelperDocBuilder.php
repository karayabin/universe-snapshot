...
namespace Ling\LingTalfi\DocBuilder\Light_SpinKitHelper;
 ...
 */
class Light_SpinKitHelperDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_SpinKitHelper";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_SpinKitHelper";
