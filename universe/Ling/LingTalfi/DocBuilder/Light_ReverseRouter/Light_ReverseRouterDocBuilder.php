...
namespace Ling\LingTalfi\DocBuilder\Light_ReverseRouter;
 ...
 */
class Light_ReverseRouterDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ReverseRouter";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ReverseRouter";
...
//                    "doctool-markup-language.md",
            ...
            "keyWord2UrlMap" => [
                ...
                "Ling.Light.on_exception_caught event" => "https://github.com/lingtalfi/Light/blob/master/personal/mydoc/pages/events.md",
...
//                "Ling\UniversalLogger\UniversalLoggerInterface" => "https://github.com/lingtalfi/UniversalLogger",
                ...
                "Ling\Light\ReverseRouter\LightReverseRouterInterface" => "https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/ReverseRouter/LightReverseRouterInterface.md",
            ],
        ];
