...
namespace Ling\LingTalfi\DocBuilder\Light_JimToolbox;
 ...
 */
class Light_JimToolboxDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_JimToolbox";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_JimToolbox";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_JimToolbox conception notes" => $conception,
                "acp response" => "https://github.com/lingtalfi/AjaxCommunicationProtocol#the-ajax-communication-protocol",
            ],
            /**
