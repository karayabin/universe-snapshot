...
//                    "doctool-markup-language.md",
            ...
            "keyWord2UrlMap" => [
                ...
                //
                "configuration command" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ConfCommand.md",
                "import-map" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ImportMapCommand.md",
                "ImportCommand" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ImportCommand.md",
                "import command" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ImportCommand.md",
                "StoreCommand" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/StoreCommand.md",
                "store command" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/StoreCommand.md",
                "ReimportCommand" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ReimportCommand.md",
                "reimportCommand" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ReimportCommand.md",
                "reimport command" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ReimportCommand.md",
                "reimport-map" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ReimportMapCommand.md",
                "ReimportMapCommand" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/ReimportMapCommand.md",
                "store-map" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Command/StoreMapCommand.md",
                "boot process" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Application/UniToolApplication/bootUniverse.md",
                "uni-tool application" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Application/UniToolApplication.md",
                "importItem method" => "https://github.com/lingtalfi/Uni2/blob/master/doc/api/Ling/Uni2/Util/ImportUtil/importItem.md",
                //
                "the local server" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-local-server",
                "Uni2 configuration" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-uni2-configuration",
                "uni-tool configuration" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-uni2-configuration",
                "dependency master page" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "the dependency master page" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "the dependency-master file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "dependency-master file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "dependency master file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "the local dependency master" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "uni-tool dependency master file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "the dependency master file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "local dependency master file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "the dependency master file page" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-dependency-master-file",
                "uni-tool upgrade-system" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-upgrade-system",
                "uni-tool upgrade system document" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#the-upgrade-system",
                "meta-info of a planet" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#meta-infobyml",
                "the meta info file" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#meta-infobyml",
                "post install directives" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#dependenciesbyml",
                "post install page" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#dependencies-byml",
                "post install directives page" => "https://github.com/lingtalfi/Uni2/blob/master/README.md#dependenciesbyml",
                "importMode definition" => "https://github.com/lingtalfi/Uni2/blob/master/doc/pages/import-mode.md",
                "\"import\" import mode" => "https://github.com/lingtalfi/Uni2/blob/master/doc/pages/import-mode.md",
                "\"store\" import mode" => "https://github.com/lingtalfi/Uni2/blob/master/doc/pages/import-mode.md",
            ],
            /**
