...
namespace Ling\LingTalfi\DocBuilder\PhpSpreadSheetTool;
 ...
 */
class PhpSpreadSheetToolDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/PhpSpreadSheetTool";
        $gitRepoUrl = "https://github.com/lingtalfi/PhpSpreadSheetTool";
