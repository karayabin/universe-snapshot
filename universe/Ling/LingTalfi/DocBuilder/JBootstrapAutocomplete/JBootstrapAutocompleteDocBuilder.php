...
namespace Ling\LingTalfi\DocBuilder\JBootstrapAutocomplete;
 ...
 */
class JBootstrapAutocompleteDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JBootstrapAutocomplete";
        $gitRepoUrl = "https://github.com/lingtalfi/JBootstrapAutocomplete";
