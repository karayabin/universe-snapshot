...
namespace Ling\LingTalfi\DocBuilder\Light_PaymentMethods;
 ...
 */
class Light_PaymentMethodsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PaymentMethods";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PaymentMethods";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_PaymentMethods conception notes" => $conception,
            ],
            /**
