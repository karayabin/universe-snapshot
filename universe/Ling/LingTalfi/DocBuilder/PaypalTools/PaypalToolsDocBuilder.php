...
namespace Ling\LingTalfi\DocBuilder\PaypalTools;
...
class PaypalToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/PaypalTools";
        $gitRepoUrl = "https://github.com/lingtalfi/PaypalTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "PaypalTools conception notes" => $conception,
            ],
            /**
