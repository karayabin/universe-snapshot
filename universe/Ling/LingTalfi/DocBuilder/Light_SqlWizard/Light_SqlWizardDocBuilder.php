...
namespace Ling\LingTalfi\DocBuilder\Light_SqlWizard;
 ...
 */
class Light_SqlWizardDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_SqlWizard";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_SqlWizard";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_SqlWizard conception notes" => $conception,
            ],
            /**
            ...
            "externalClass2Url" => [
                ...
                "Ling\SqlWizard\MysqlWizard" => "https://github.com/lingtalfi/SqlWizard/blob/master/doc/api/Ling/SqlWizard/MysqlWizard.md",
