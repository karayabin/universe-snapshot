...
namespace Ling\LingTalfi\DocBuilder\Light_BMenu;
...
class Light_BMenuDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_BMenu";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_BMenu";
