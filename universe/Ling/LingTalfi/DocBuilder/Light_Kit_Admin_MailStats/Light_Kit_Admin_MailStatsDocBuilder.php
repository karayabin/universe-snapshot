...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_Admin_MailStats;
 ...
 */
class Light_Kit_Admin_MailStatsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_Admin_MailStats";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_Admin_MailStats";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Kit_Admin_MailStats conception notes" => $conception,
