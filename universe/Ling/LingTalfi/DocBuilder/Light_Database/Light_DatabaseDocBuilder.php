...
namespace Ling\LingTalfi\DocBuilder\Light_Database;
 ...
 */
class Light_DatabaseDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Database";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Database";
        ...
        $options = [
             ...
             */
            "reportIgnore" => [
                "Ling\SimplePdoWrapper\SimplePdoWrapper",
...
//                    "doctool-markup-language.md",
            ...
            "externalClass2Url" => [
                ...
                "Ling\Light_PlanetInstaller\PlanetInstaller\LightPlanetInstallerInit1HookInterface" => "https://github.com/lingtalfi/Light_PlanetInstaller/blob/master/doc/api/Ling/Light_PlanetInstaller/PlanetInstaller/LightPlanetInstallerInit1HookInterface.md",
