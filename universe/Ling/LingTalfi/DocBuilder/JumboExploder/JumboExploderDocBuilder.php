...
namespace Ling\LingTalfi\DocBuilder\JumboExploder;
...
class JumboExploderDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JumboExploder";
        $gitRepoUrl = "https://github.com/lingtalfi/JumboExploder";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JumboExploder conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
