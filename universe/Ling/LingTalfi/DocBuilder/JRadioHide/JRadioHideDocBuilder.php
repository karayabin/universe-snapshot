...
namespace Ling\LingTalfi\DocBuilder\JRadioHide;
 ...
 */
class JRadioHideDocBuilder
{


    /**
     * Launch this function to generate the documentation for the JRadioHide planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/JRadioHide/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JRadioHide";
        $gitRepoUrl = "https://github.com/lingtalfi/JRadioHide";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JRadioHide conception notes" => $conception,
            ],
            /**
