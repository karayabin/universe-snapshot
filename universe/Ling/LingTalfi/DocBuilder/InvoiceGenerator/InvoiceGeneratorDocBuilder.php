...
namespace Ling\LingTalfi\DocBuilder\InvoiceGenerator;
 ...
 */
class InvoiceGeneratorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/InvoiceGenerator";
        $gitRepoUrl = "https://github.com/lingtalfi/InvoiceGenerator";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "InvoiceGenerator conception notes" => $conception,
            ],
            /**
