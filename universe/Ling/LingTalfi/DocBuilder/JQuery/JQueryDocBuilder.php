...
namespace Ling\LingTalfi\DocBuilder\JQuery;
...
class JQueryDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JQuery";
        $gitRepoUrl = "https://github.com/lingtalfi/JQuery";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JQuery conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
