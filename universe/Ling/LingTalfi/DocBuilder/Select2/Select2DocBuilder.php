...
namespace Ling\LingTalfi\DocBuilder\Select2;
...
class Select2DocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Select2";
        $gitRepoUrl = "https://github.com/lingtalfi/Select2";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Select2 conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
