...
namespace Ling\LingTalfi\DocBuilder\Light_LingStandardService;
 ...
 */
class Light_LingStandardServiceDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_LingStandardService";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_LingStandardService";
