...
namespace Ling\LingTalfi\DocBuilder\UrlSmuggler;
...
class UrlSmugglerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/UrlSmuggler";
        $gitRepoUrl = "https://github.com/lingtalfi/UrlSmuggler";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "UrlSmuggler conception notes" => $conception,
            ],
            /**
