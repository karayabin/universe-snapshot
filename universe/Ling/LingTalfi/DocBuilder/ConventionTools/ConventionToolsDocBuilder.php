...
namespace Ling\LingTalfi\DocBuilder\ConventionTools;
 ...
 */
class ConventionToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ConventionTools";
        $gitRepoUrl = "https://github.com/lingtalfi/ConventionTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "ConventionTools conception notes" => $conception,
            ],
            /**
