...
namespace Ling\LingTalfi\DocBuilder\ExceptionCodes;
 ...
 */
class ExceptionCodesDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ExceptionCodes";
        $gitRepoUrl = "https://github.com/lingtalfi/ExceptionCodes";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "ExceptionCodes conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
