...
namespace Ling\LingTalfi\DocBuilder\Light_Mailer;
...
class Light_MailerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Mailer";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Mailer";
