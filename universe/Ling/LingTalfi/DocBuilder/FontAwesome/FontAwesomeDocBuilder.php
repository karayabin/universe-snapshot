...
namespace Ling\LingTalfi\DocBuilder\FontAwesome;
...
class FontAwesomeDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/FontAwesome";
        $gitRepoUrl = "https://github.com/lingtalfi/FontAwesome";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "FontAwesome conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
