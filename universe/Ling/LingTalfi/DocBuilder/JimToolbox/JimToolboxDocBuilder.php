...
namespace Ling\LingTalfi\DocBuilder\JimToolbox;
...
class JimToolboxDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JimToolbox";
        $gitRepoUrl = "https://github.com/lingtalfi/JimToolbox";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JimToolbox conception notes" => $conception,
            ],
            /**
