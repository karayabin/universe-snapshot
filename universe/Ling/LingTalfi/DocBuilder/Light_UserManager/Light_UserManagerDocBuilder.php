...
namespace Ling\LingTalfi\DocBuilder\Light_UserManager;
 ...
 */
class Light_UserManagerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_UserManager";
        $git = "https://github.com/lingtalfi/Light_UserManager/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
