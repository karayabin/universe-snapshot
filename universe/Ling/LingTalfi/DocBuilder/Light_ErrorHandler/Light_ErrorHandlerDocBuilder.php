...
namespace Ling\LingTalfi\DocBuilder\Light_ErrorHandler;
 ...
 */
class Light_ErrorHandlerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ErrorHandler";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ErrorHandler";
