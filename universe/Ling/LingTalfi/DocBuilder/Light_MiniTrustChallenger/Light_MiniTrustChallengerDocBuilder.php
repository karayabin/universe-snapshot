...
namespace Ling\LingTalfi\DocBuilder\Light_MiniTrustChallenger;
 ...
 */
class Light_MiniTrustChallengerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_MiniTrustChallenger";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_MiniTrustChallenger";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_MiniTrustChallenger conception notes" => $conception,
            ],
            /**
