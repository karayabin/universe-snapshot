...
namespace Ling\LingTalfi\DocBuilder\EasyConsoleMenu;
 ...
 */
class EasyConsoleMenuDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/EasyConsoleMenu";
        $git = "https://github.com/lingtalfi/EasyConsoleMenu/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "configuration file" => $doc . '/pages/easy-menu-configuration-file.md',
                "the configuration file" => $doc . '/pages/easy-menu-configuration-file.md',
                "MenuExecutor" => $api . '/Ling/EasyConsoleMenu/MenuExecutor.md',
                "StepsHistory" => $api . '/Ling/EasyConsoleMenu/History/StepsHistory.md',
                "Bashtml color" => 'https://github.com/lingtalfi/CliTools/blob/master/doc/pages/bashtml.md#the-tags-list',
                "Bashtml" => 'https://github.com/lingtalfi/CliTools/blob/master/doc/pages/bashtml.md#the-tags-list',
                "KrankenStein one shot" => 'https://github.com/lingtalfi/KrankenStein#one-shot-notation',
            ],
            /**
