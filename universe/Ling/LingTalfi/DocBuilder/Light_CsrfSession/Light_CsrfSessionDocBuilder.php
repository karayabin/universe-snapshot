...
namespace Ling\LingTalfi\DocBuilder\Light_CsrfSession;
 ...
 */
class Light_CsrfSessionDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_CsrfSession";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_CsrfSession";
