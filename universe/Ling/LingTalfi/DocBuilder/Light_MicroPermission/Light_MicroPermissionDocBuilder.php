...
namespace Ling\LingTalfi\DocBuilder\Light_MicroPermission;
 ...
 */
class Light_MicroPermissionDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_MicroPermission";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_MicroPermission";
