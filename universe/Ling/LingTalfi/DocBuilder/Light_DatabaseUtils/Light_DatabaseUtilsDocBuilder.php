...
namespace Ling\LingTalfi\DocBuilder\Light_DatabaseUtils;
 ...
 */
class Light_DatabaseUtilsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_DatabaseUtils";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_DatabaseUtils";
