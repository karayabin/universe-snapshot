...
namespace Ling\LingTalfi\DocBuilder\SvelteTemplateBuilder;
 ...
 */
class SvelteTemplateBuilderDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/SvelteTemplateBuilder";
        $gitRepoUrl = "https://github.com/lingtalfi/SvelteTemplateBuilder";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "SvelteTemplateBuilder conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
