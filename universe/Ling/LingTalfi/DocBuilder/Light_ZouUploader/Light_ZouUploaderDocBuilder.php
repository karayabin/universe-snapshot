...
namespace Ling\LingTalfi\DocBuilder\Light_ZouUploader;
 ...
 */
class Light_ZouUploaderDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ZouUploader";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ZouUploader";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_ZouUploader conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
