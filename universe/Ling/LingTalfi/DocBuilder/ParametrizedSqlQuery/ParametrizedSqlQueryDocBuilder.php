...
namespace Ling\LingTalfi\DocBuilder\ParametrizedSqlQuery;
 ...
 */
class ParametrizedSqlQueryDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ParametrizedSqlQuery";
        $gitRepoUrl = "https://github.com/lingtalfi/ParametrizedSqlQuery";
...
//                    "doctool-markup-language.md",
            ...
            "keyWord2UrlMap" => [
                ...
                "the open admin protocol" =>  'https://github.com/lingtalfi/Light_Realist/blob/master/doc/pages/older/open-admin-table-protocol.md',
                "the routines section" =>  'https://github.com/lingtalfi/Light_Realist/blob/master/doc/pages/older/duelist.md#routines',
            ],
            /**
