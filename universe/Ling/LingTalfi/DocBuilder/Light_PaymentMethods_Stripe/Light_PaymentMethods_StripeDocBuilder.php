...
namespace Ling\LingTalfi\DocBuilder\Light_PaymentMethods_Stripe;
 ...
 */
class Light_PaymentMethods_StripeDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PaymentMethods_Stripe";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PaymentMethods_Stripe";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_PaymentMethods_Stripe conception notes" => $conception,
            ],
            /**
