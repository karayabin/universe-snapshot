...
namespace Ling\LingTalfi\DocBuilder\JSortableLists;
 ...
 */
class JSortableListsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JSortableLists";
        $gitRepoUrl = "https://github.com/lingtalfi/JSortableLists";
