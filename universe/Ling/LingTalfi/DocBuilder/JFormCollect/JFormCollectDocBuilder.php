...
namespace Ling\LingTalfi\DocBuilder\JFormCollect;
...
class JFormCollectDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JFormCollect";
        $gitRepoUrl = "https://github.com/lingtalfi/JFormCollect";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JFormCollect conception notes" => $conception,
            ],
            /**
