...
namespace Ling\LingTalfi\DocBuilder\Light_HtmlPageCopilot;
 ...
 */
class Light_HtmlPageCopilotDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_HtmlPageCopilot";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_HtmlPageCopilot";
