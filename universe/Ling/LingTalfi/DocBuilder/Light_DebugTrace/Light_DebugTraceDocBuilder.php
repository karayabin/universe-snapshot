...
namespace Ling\LingTalfi\DocBuilder\Light_DebugTrace;
 ...
 */
class Light_DebugTraceDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_DebugTrace";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_DebugTrace";
