...
namespace Ling\LingTalfi\DocBuilder\Light_LoginNotifier;
 ...
 */
class Light_LoginNotifierDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_LoginNotifier";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_LoginNotifier";
