...
namespace Ling\LingTalfi\DocBuilder\Panda_Headers;
...
class Panda_HeadersDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Panda_Headers";
        $gitRepoUrl = "https://github.com/lingtalfi/Panda_Headers";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "panda headers" => "https://github.com/lingtalfi/TheBar/blob/master/discussions/panda-headers-protocol.md",
            ],
            /**
