...
namespace Ling\LingTalfi\DocBuilder\BabyYamlDatabase;
 ...
 */
class BabyYamlDatabaseDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/BabyYamlDatabase";
        $gitRepoUrl = "https://github.com/lingtalfi/BabyYamlDatabase";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "constraints checking" => $doc . '/pages/conception-notes.md#constraints-checks',
