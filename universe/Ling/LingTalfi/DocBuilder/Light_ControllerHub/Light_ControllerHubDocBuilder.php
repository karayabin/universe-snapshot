...
namespace Ling\LingTalfi\DocBuilder\Light_ControllerHub;
 ...
 */
class Light_ControllerHubDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ControllerHub";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ControllerHub";
