...
namespace Ling\LingTalfi\DocBuilder\Light_SimpleHttpServer;
 ...
 */
class Light_SimpleHttpServerDocBuilder
{


    /**
     * Launch this function to generate the documentation for the Light_SimpleHttpServer planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/Light_SimpleHttpServer/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_SimpleHttpServer";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_SimpleHttpServer";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_SimpleHttpServer conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
