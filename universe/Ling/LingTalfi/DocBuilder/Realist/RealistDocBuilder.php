...
namespace Ling\LingTalfi\DocBuilder\Realist;
...
class RealistDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Realist";
        $gitRepoUrl = "https://github.com/lingtalfi/Realist";
