...
namespace Ling\LingTalfi\DocBuilder\LogicalOperator;
 ...
 */
class LogicalOperatorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/LogicalOperator";
        $gitRepoUrl = "https://github.com/lingtalfi/LogicalOperator";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "LogicalOperator conception notes" => $conception,
            ],
            /**
