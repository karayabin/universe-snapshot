...
namespace Ling\LingTalfi\DocBuilder\JqZoom;
...
class JqZoomDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JqZoom";
        $gitRepoUrl = "https://github.com/lingtalfi/JqZoom";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JqZoom conception notes" => $conception,
            ],
            /**
