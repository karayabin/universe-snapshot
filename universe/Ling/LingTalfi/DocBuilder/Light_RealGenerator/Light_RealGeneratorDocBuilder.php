...
namespace Ling\LingTalfi\DocBuilder\Light_RealGenerator;
 ...
 */
class Light_RealGeneratorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_RealGenerator";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_RealGenerator";
