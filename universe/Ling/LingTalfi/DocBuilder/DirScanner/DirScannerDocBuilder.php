...
namespace Ling\LingTalfi\DocBuilder\DirScanner;
...
class DirScannerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/DirScanner";
        $git = "https://github.com/lingtalfi/DirScanner/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
