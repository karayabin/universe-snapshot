...
namespace Ling\LingTalfi\DocBuilder\SqlQuery;
...
class SqlQueryDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/SqlQuery";
        $gitRepoUrl = "https://github.com/lingtalfi/SqlQuery";
