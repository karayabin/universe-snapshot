...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_Admin_DebugTrace;
 ...
 */
class Light_Kit_Admin_DebugTraceDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_Admin_DebugTrace";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_Admin_DebugTrace";
