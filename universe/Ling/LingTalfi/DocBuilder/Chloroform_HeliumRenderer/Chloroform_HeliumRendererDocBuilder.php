...
namespace Ling\LingTalfi\DocBuilder\Chloroform_HeliumRenderer;
 ...
 */
class Chloroform_HeliumRendererDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Chloroform_HeliumRenderer";
        $gitRepoUrl = "https://github.com/lingtalfi/Chloroform_HeliumRenderer";
