...
namespace Ling\LingTalfi\DocBuilder\SimplePdoWrapper;
 ...
 */
class SimplePdoWrapperDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/SimplePdoWrapper";
        $gitRepoUrl = "https://github.com/lingtalfi/SimplePdoWrapper";
