...
namespace Ling\LingTalfi\DocBuilder\Light_QuickMailAlert;
 ...
 */
class Light_QuickMailAlertDocBuilder
{


    /**
     * Launch this function to generate the documentation for the Light_QuickMailAlert planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/Light_QuickMailAlert/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_QuickMailAlert";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_QuickMailAlert";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_QuickMailAlert conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
