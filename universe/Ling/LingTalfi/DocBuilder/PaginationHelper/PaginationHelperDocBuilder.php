...
namespace Ling\LingTalfi\DocBuilder\PaginationHelper;
 ...
 */
class PaginationHelperDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/PaginationHelper";
        $gitRepoUrl = "https://github.com/lingtalfi/PaginationHelper";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "PaginationHelper conception notes" => $conception,
            ],
            /**
