...
namespace Ling\LingTalfi\DocBuilder\Light_Firewall;
 ...
 */
class Light_FirewallDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Firewall";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Firewall";
