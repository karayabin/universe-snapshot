...
namespace Ling\LingTalfi\DocBuilder\Light_Events;
...
class Light_EventsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Events";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Events";
