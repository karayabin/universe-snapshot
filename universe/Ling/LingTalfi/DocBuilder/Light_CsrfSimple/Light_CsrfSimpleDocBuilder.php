...
namespace Ling\LingTalfi\DocBuilder\Light_CsrfSimple;
 ...
 */
class Light_CsrfSimpleDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_CsrfSimple";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_CsrfSimple";
