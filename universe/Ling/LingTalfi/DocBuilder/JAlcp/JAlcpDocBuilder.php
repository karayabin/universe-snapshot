...
namespace Ling\LingTalfi\DocBuilder\JAlcp;
...
class JAlcpDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JAlcp";
        $gitRepoUrl = "https://github.com/lingtalfi/JAlcp";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JAlcp conception notes" => $conception,
            ],
            /**
