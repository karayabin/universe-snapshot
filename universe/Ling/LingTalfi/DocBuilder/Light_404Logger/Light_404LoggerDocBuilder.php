...
namespace Ling\LingTalfi\DocBuilder\Light_404Logger;
 ...
 */
class Light_404LoggerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_404Logger";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_404Logger";
