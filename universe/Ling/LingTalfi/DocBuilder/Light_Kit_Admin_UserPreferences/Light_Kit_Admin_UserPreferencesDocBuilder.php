...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_Admin_UserPreferences;
 ...
 */
class Light_Kit_Admin_UserPreferencesDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_Admin_UserPreferences";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_Admin_UserPreferences";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Kit_Admin_UserPreferences conception notes" => $doc . '/pages/conception-notes.md',
