...
namespace Ling\LingTalfi\DocBuilder\KrankenStein;
...
class KrankenSteinDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/KrankenStein";
        $git = "https://github.com/lingtalfi/KrankenStein/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "one shot" => $git . '/README.md#one-shot-notation',
            ],
            /**
