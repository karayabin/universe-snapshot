...
namespace Ling\LingTalfi\DocBuilder\JBee;
...
class JBeeDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JBee";
        $gitRepoUrl = "https://github.com/lingtalfi/JBee";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JBee conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
