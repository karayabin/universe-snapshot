...
namespace Ling\LingTalfi\DocBuilder\CyclicChainDetector;
 ...
 */
class CyclicChainDetectorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/CyclicChainDetector";
        $gitRepoUrl = "https://github.com/lingtalfi/CyclicChainDetector";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "CyclicChainDetector conception notes" => $conception,
            ],
            /**
