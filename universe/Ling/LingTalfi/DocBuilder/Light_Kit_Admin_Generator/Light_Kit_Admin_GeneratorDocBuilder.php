...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_Admin_Generator;
 ...
 */
class Light_Kit_Admin_GeneratorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_Admin_Generator";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_Admin_Generator";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "config block" => $doc . '/pages/lkagen-configuration-example.md',
                "configuration block" => $doc . '/pages/lkagen-configuration-example.md',
             ...
             */
            "externalClass2Url" => [
                "Ling\Light_RealGenerator\Exception\LightRealGeneratorException" => "https://github.com/lingtalfi/Light_RealGenerator/blob/master/doc/api/Ling/Light_RealGenerator/Exception/LightRealGeneratorException.md",
