...
namespace Ling\LingTalfi\DocBuilder\JLingHelpers;
...
class JLingHelpersDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/JLingHelpers";
        $gitRepoUrl = "https://github.com/lingtalfi/JLingHelpers";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "JLingHelpers conception notes" => $conception,
            ],
            /**
