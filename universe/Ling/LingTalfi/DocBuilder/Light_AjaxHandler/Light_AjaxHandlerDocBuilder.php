...
namespace Ling\LingTalfi\DocBuilder\Light_AjaxHandler;
 ...
 */
class Light_AjaxHandlerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_AjaxHandler";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_AjaxHandler";
