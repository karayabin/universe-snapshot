...
namespace Ling\LingTalfi\DocBuilder\ClassCooker;
...
class ClassCookerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ClassCooker";
        $gitRepoUrl = "https://github.com/lingtalfi/ClassCooker";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
//                "ClassCooker conception notes" => $doc . '/pages/conception-notes.md',
                'ClassCookerHelper::getMethodsBoundaries' => $api . "/Ling/ClassCooker/Helper/ClassCookerHelper/getMethodsBoundaries.md",
                'docblock comment' => 'https://github.com/lingtalfi/TheBar/blob/master/discussions/docblock-comment.md',
                'section comment' => 'https://github.com/lingtalfi/TheBar/blob/master/discussions/section-comment.md',
                'frying pan conception notes' => $doc . '/pages/frying-pan-conception-notes.md',
                'basic constructor' => $doc . '/pages/frying-pan-conception-notes.md#the-basic-constructor',
                'ClassCooker->addMethod' => 'https://github.com/lingtalfi/ClassCooker/blob/master/doc/api/Ling/ClassCooker/ClassCooker/addMethod.md',
                'ClassCooker->addProperty' => 'https://github.com/lingtalfi/ClassCooker/blob/master/doc/api/Ling/ClassCooker/ClassCooker/addProperty.md',
            ],
            /**
