...
namespace Ling\LingTalfi\DocBuilder\CheapLogger;
...
class CheapLoggerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/CheapLogger";
        $gitRepoUrl = "https://github.com/lingtalfi/CheapLogger";
