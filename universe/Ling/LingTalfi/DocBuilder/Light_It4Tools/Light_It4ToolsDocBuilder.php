...
namespace Ling\LingTalfi\DocBuilder\Light_It4Tools;
 ...
 */
class Light_It4ToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_It4Tools";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_It4Tools";
