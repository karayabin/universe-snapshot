...
namespace Ling\LingTalfi\DocBuilder\Light_PrerouteHub;
 ...
 */
class Light_PrerouteHubDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PrerouteHub";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PrerouteHub";
