...
namespace Ling\LingTalfi\DocBuilder\Light_ExceptionHandler;
 ...
 */
class Light_ExceptionHandlerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ExceptionHandler";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ExceptionHandler";
