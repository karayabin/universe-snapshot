...
namespace Ling\LingTalfi\DocBuilder\ParenthesisMirrorParser;
 ...
 */
class ParenthesisMirrorParserDocBuilder
{


    /**
     * Launch this function to generate the documentation for the ParenthesisMirrorParser planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/ParenthesisMirrorParser/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/ParenthesisMirrorParser";
        $gitRepoUrl = "https://github.com/lingtalfi/ParenthesisMirrorParser";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "ParenthesisMirrorParser conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
