...
namespace Ling\LingTalfi\DocBuilder\Chloroform_Bootstrap4Renderer;
 ...
 */
class Chloroform_Bootstrap4RendererDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Chloroform_Bootstrap4Renderer";
        $gitRepoUrl = "https://github.com/lingtalfi/Chloroform_Bootstrap4Renderer";
