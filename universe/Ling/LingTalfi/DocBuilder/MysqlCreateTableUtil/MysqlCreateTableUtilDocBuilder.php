...
namespace Ling\LingTalfi\DocBuilder\MysqlCreateTableUtil;
 ...
 */
class MysqlCreateTableUtilDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/MysqlCreateTableUtil";
        $gitRepoUrl = "https://github.com/lingtalfi/MysqlCreateTableUtil";
