...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_Admin_UserNotifications;
 ...
 */
class Light_Kit_Admin_UserNotificationsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_Admin_UserNotifications";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_Admin_UserNotifications";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Kit_Admin_UserNotifications conception notes" => $conception,
