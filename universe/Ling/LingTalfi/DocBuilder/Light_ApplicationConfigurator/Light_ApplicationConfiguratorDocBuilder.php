...
namespace Ling\LingTalfi\DocBuilder\Light_ApplicationConfigurator;
 ...
 */
class Light_ApplicationConfiguratorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_ApplicationConfigurator";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_ApplicationConfigurator";
