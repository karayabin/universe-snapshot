...
namespace Ling\LingTalfi\DocBuilder\Light_DatabaseInfo;
 ...
 */
class Light_DatabaseInfoDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_DatabaseInfo";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_DatabaseInfo";
