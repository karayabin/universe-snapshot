...
namespace Ling\LingTalfi\DocBuilder\Light_PluginInstaller;
 ...
 */
class Light_PluginInstallerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PluginInstaller";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PluginInstaller";
