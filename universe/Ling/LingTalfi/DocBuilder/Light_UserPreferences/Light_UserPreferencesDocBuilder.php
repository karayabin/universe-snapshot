...
namespace Ling\LingTalfi\DocBuilder\Light_UserPreferences;
 ...
 */
class Light_UserPreferencesDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_UserPreferences";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_UserPreferences";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_UserPreferences conception notes" => $doc . '/pages/conception-notes.md',
