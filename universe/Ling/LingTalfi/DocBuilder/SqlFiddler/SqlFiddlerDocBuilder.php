...
namespace Ling\LingTalfi\DocBuilder\SqlFiddler;
...
class SqlFiddlerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/SqlFiddler";
        $gitRepoUrl = "https://github.com/lingtalfi/SqlFiddler";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "SqlFiddler conception notes" => $conception,
            ],
            /**
