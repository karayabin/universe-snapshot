...
namespace Ling\LingTalfi\DocBuilder\HashMap;
...
class HashMapDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/HashMap";
        $git = "https://github.com/lingtalfi/HashMap/blob/master";
        $doc = "$git/doc";
        $api = $doc . "/api";
