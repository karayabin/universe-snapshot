...
namespace Ling\LingTalfi\DocBuilder\Light_PasswordProtector;
 ...
 */
class Light_PasswordProtectorDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_PasswordProtector";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_PasswordProtector";
