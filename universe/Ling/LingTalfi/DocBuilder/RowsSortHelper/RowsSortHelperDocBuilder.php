...
namespace Ling\LingTalfi\DocBuilder\RowsSortHelper;
 ...
 */
class RowsSortHelperDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/RowsSortHelper";
        $gitRepoUrl = "https://github.com/lingtalfi/RowsSortHelper";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "RowsSortHelper conception notes" => $conception,
            ],
            /**
