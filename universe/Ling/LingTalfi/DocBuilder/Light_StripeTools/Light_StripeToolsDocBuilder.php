...
namespace Ling\LingTalfi\DocBuilder\Light_StripeTools;
 ...
 */
class Light_StripeToolsDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_StripeTools";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_StripeTools";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_StripeTools conception notes" => $conception,
            ],
            /**
