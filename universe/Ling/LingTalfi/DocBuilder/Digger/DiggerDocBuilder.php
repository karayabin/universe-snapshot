...
namespace Ling\LingTalfi\DocBuilder\Digger;
...
class DiggerDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Digger";
        $gitRepoUrl = "https://github.com/lingtalfi/Digger";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Digger conception notes" => $conception,
            ],
            /**
