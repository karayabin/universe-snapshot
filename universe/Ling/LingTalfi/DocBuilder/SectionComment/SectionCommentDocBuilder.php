...
namespace Ling\LingTalfi\DocBuilder\SectionComment;
 ...
 */
class SectionCommentDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/SectionComment";
        $gitRepoUrl = "https://github.com/lingtalfi/SectionComment";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "SectionComment conception notes" => $conception,
            ],
            /**
