...
namespace Ling\LingTalfi\DocBuilder\Light_Realform;
 ...
 */
class Light_RealformDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Realform";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Realform";
