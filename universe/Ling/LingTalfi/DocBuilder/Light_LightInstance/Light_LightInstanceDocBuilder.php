...
namespace Ling\LingTalfi\DocBuilder\Light_LightInstance;
 ...
 */
class Light_LightInstanceDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_LightInstance";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_LightInstance";
...
//                    "doctool-markup-language.md",
            ...
            "externalClass2Url" => [
                ...
                "Ling\Light\Http\HttpRequestInterface" => "https://github.com/lingtalfi/Light/blob/master/doc/api/Ling/Light/Http/HttpRequestInterface.md",
            ],
