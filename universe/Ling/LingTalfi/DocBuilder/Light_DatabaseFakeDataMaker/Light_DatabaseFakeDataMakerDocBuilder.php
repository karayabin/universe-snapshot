...
namespace Ling\LingTalfi\DocBuilder\Light_DatabaseFakeDataMaker;
 ...
 */
class Light_DatabaseFakeDataMakerDocBuilder
{


    /**
     * Launch this function to generate the documentation for the Light_DatabaseFakeDataMaker planet.
     * (based on the LingGitPhpPlanetDocBuilder doc builder.
     *
     * If htmlMode is true (the default),
     * this method will generate all files in md format in the following directory:
     *
     * - /myphp/universe/Light_DatabaseFakeDataMaker/doc
     *
     *
     *
     * If htmlMode is true,
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_DatabaseFakeDataMaker";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_DatabaseFakeDataMaker";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_DatabaseFakeDataMaker conception notes" => $conception,
