...
namespace Ling\LingTalfi\DocBuilder\GormanJsonDecoder;
 ...
 */
class GormanJsonDecoderDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/GormanJsonDecoder";
        $gitRepoUrl = "https://github.com/lingtalfi/GormanJsonDecoder";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "GormanJsonDecoder conception notes" => $doc . '/pages/conception-notes.md',
            ],
            /**
