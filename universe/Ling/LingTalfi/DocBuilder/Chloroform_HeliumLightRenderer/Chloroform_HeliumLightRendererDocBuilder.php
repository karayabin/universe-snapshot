...
namespace Ling\LingTalfi\DocBuilder\Chloroform_HeliumLightRenderer;
 ...
 */
class Chloroform_HeliumLightRendererDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Chloroform_HeliumLightRenderer";
        $gitRepoUrl = "https://github.com/lingtalfi/Chloroform_HeliumLightRenderer";
        ...
        $options = [
             ...
             */
            "reportIgnore" => [
                "Ling\Chloroform_HeliumRenderer\HeliumRenderer",
            ],
            /**
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Chloroform toArray" => 'https://github.com/lingtalfi/Chloroform/blob/master/doc/pages/chloroform-array.md',
             ...
             */
            "externalClass2Url" => [
                "Ling\Chloroform_HeliumRenderer\Exception\ChloroformHeliumRendererException" => "https://github.com/lingtalfi/Chloroform_HeliumRenderer/blob/master/doc/api/Ling/Chloroform_HeliumRenderer/Exception/ChloroformHeliumRendererException.md",
                "Ling\Chloroform_HeliumRenderer\HeliumRenderer" => "https://github.com/lingtalfi/Chloroform_HeliumRenderer/blob/master/doc/api/Ling/Chloroform_HeliumRenderer/HeliumRenderer.md",
