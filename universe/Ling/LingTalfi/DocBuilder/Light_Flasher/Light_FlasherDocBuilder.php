...
namespace Ling\LingTalfi\DocBuilder\Light_Flasher;
...
class Light_FlasherDocBuilder
{
    ...
    public static function buildDoc($htmlMode = false)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Flasher";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Flasher";
