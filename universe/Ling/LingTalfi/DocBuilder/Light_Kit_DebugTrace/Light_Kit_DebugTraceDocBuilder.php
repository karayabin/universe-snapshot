...
namespace Ling\LingTalfi\DocBuilder\Light_Kit_DebugTrace;
 ...
 */
class Light_Kit_DebugTraceDocBuilder
{
    ...
    public static function buildDoc($htmlMode = true)
    {
        ...
        //--------------------------------------------
        $planetDir = "/myphp/universe/Ling/Light_Kit_DebugTrace";
        $gitRepoUrl = "https://github.com/lingtalfi/Light_Kit_DebugTrace";
...
//                    "doctool-markup-language.md",
             ...
             */
            "keyWord2UrlMap" => [
                "Light_Kit_DebugTrace conception notes" => $conception,
