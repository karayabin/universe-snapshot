...
CommitWizard::msg — Writes a message to the output.
...
private [CommitWizard::msg](https://github.com/lingtalfi/LingTalfi/blob/master/doc/api/Ling/LingTalfi/Kaos/Util/CommitWizard/msg.md)(string $msg) : void
...
Source Code
===========
See the source code for method [CommitWizard::msg](https://github.com/lingtalfi/LingTalfi/blob/master/Kaos/Util/CommitWizard.php#L234-L237)
