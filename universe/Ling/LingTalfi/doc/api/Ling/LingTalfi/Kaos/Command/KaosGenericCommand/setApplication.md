...
KaosGenericCommand::setApplication
================



KaosGenericCommand::setApplication — Sets the application.
...
Previous method: [__construct](https://github.com/lingtalfi/LingTalfi/blob/master/doc/api/Ling/LingTalfi/Kaos/Command/KaosGenericCommand/__construct.md)<br>
