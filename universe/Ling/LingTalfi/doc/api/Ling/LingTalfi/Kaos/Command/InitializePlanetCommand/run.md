...
public [InitializePlanetCommand::run](https://github.com/lingtalfi/LingTalfi/blob/master/doc/api/Ling/LingTalfi/Kaos/Command/InitializePlanetCommand/run.md)(Ling\CliTools\Input\InputInterface $input, Ling\CliTools\Output\OutputInterface $output) : int
...
Source Code
===========
See the source code for method [InitializePlanetCommand::run](https://github.com/lingtalfi/LingTalfi/blob/master/Kaos/Command/InitializePlanetCommand.php#L38-L262)
