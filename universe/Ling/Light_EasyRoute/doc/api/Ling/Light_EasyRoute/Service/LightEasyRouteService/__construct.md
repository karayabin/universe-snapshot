...
Source Code
===========
See the source code for method [LightEasyRouteService::__construct](https://github.com/lingtalfi/Light_EasyRoute/blob/master/Service/LightEasyRouteService.php#L32-L35)
