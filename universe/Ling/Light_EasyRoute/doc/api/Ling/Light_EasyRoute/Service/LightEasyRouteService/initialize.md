...
Source Code
===========
See the source code for method [LightEasyRouteService::initialize](https://github.com/lingtalfi/Light_EasyRoute/blob/master/Service/LightEasyRouteService.php#L45-L70)
