...
**Open admin table one** (oat1) is a renderer implementation guideline for the [open-admin-table protocol](https://github.com/lingtalfi/Light_Realist/blob/master/doc/pages/open-admin-table-protocol.md).
