...
Source Code
===========
See the source code for method [LightRealistService::executeListAction](https://github.com/lingtalfi/Light_Realist/blob/master/Service/LightRealistService.php#L515-L520)
