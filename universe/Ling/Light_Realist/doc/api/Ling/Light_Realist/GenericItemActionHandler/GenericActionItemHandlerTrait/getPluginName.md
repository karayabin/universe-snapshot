...
Source Code
===========
See the source code for method [GenericActionItemHandlerTrait::getPluginName](https://github.com/lingtalfi/Light_Realist/blob/master/GenericItemActionHandler/GenericActionItemHandlerTrait.php#L217-L223)
