...
BaseRealistListItemRenderer::setContainer
================



BaseRealistListItemRenderer::setContainer — Sets the light service container interface.
...
Previous method: [__construct](https://github.com/lingtalfi/Light_Realist/blob/master/doc/api/Ling/Light_Realist/Rendering/BaseRealistListItemRenderer/__construct.md)<br>Next method: [setRequestId](https://github.com/lingtalfi/Light_Realist/blob/master/doc/api/Ling/Light_Realist/Rendering/BaseRealistListItemRenderer/setRequestId.md)<br>
