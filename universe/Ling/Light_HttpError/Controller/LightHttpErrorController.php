...
namespace Ling\Light_HttpError\Controller;
...
use Ling\Light_HttpError\Service\LightHttpErrorService;


/**
 * The LightHttpErrorController class.
 */
abstract class LightHttpErrorController extends LightController
{
    ...
    public function render(HttpRequestInterface $request): HttpResponseInterface
    {
        try {
            ...
            if (true === $e instanceof LightHttpErrorException) {
            ...
            if (false === in_array($httpStatusCode, $noLogHttpStatusCodes, true)) {
                ...
                $events->dispatch("Light_HttpError.on_controller_exception_caught", $data);
            }
