...
namespace Ling\BeeFramework\Component\Http\CurlWrapper\Tool;
...
class CurlWrapperTool
{
    ...
    public static function optionToLiteral($optionName)
    {
        if (array_key_exists($optionName, self::$options)) {
            return self::$options[$optionName];
        }
        throw new CurlWrapperException("Unknown option: $optionName");
    }
}
