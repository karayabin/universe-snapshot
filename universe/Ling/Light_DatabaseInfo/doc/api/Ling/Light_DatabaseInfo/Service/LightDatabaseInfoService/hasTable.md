...
Source Code
===========
See the source code for method [LightDatabaseInfoService::hasTable](https://github.com/lingtalfi/Light_DatabaseInfo/blob/master/Service/LightDatabaseInfoService.php#L201-L205)
