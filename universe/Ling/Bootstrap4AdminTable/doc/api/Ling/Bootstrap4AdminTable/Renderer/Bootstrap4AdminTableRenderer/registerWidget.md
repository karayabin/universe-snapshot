...
Bootstrap4AdminTableRenderer::registerWidget
================



Bootstrap4AdminTableRenderer::registerWidget — Registers a widget.
...
Registers a widget.
The possible widget identifiers are listed in the [conception notes](https://github.com/lingtalfi/Bootstrap4AdminTable/blob/master/doc/pages/conception-notes.md).
...
Source Code
===========
See the source code for method [Bootstrap4AdminTableRenderer::registerWidget](https://github.com/lingtalfi/Bootstrap4AdminTable/blob/master/Renderer/Bootstrap4AdminTableRenderer.php#L62-L66)
...
Previous method: [__construct](https://github.com/lingtalfi/Bootstrap4AdminTable/blob/master/doc/api/Ling/Bootstrap4AdminTable/Renderer/Bootstrap4AdminTableRenderer/__construct.md)<br>Next method: [setUseSpinKitService](https://github.com/lingtalfi/Bootstrap4AdminTable/blob/master/doc/api/Ling/Bootstrap4AdminTable/Renderer/Bootstrap4AdminTableRenderer/setUseSpinKitService.md)<br>
