...
Light404LoggerPlanetInstaller::init2
================



Light404LoggerPlanetInstaller::init2 — Executes the init 2 phase of the install command.
...
Next method: [undoInit2](https://github.com/lingtalfi/Light_404Logger/blob/master/doc/api/Ling/Light_404Logger/Light_PlanetInstaller/Light404LoggerPlanetInstaller/undoInit2.md)<br>
