...
LightWebsiteUser::setLastRefreshTime
================



LightWebsiteUser::setLastRefreshTime — Sets the last_refresh_time.
...
public [LightWebsiteUser::setLastRefreshTime](https://github.com/lingtalfi/Light_User/blob/master/doc/api/Ling/Light_User/LightWebsiteUser/setLastRefreshTime.md)(int $last_refresh_time) : void
