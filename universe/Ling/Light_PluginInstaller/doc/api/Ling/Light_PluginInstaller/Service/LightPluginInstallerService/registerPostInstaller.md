...
LightPluginInstallerService::registerPostInstaller
================



LightPluginInstallerService::registerPostInstaller — Registers a post installer.
...
public [LightPluginInstallerService::registerPostInstaller](https://github.com/lingtalfi/Light_PluginInstaller/blob/master/doc/api/Ling/Light_PluginInstaller/Service/LightPluginInstallerService/registerPostInstaller.md)(int $level, callable $postInstaller) : void
