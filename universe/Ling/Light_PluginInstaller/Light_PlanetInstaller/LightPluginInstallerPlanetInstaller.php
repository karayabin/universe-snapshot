...
namespace Ling\Light_PluginInstaller\Light_PlanetInstaller;
 ...
 */
class LightPluginInstallerPlanetInstaller extends LightBasePlanetInstaller implements LightPlanetInstallerInit2HookInterface
{
    ...
    public function init2(string $appDir, OutputInterface $output, array $options = []): void
    {
        ...
        $planetDotName = "Ling.Light_PluginInstaller";
