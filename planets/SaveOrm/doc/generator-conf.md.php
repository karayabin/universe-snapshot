...
/**
 * This is the demo conf for the generator.
 * Read the comments to learn how to configure the generator.
 */
...
$conf = [
     ...
     */
    'baseDir' => "/myphp/leaderfit/leaderfit/class/SaveOrm/Test",
    /**
     *
     */
...
//                'ekev_*',
    ...
    /**
     * Define host/guest bindings.
     * See bindings relationship in the documentation for more info on bindings.
     *
     * It's an array with the following structure:
     *
     * - $hostDatabase:
     *      - $hostTable:
     *          - $guestDatabase.$guestTable
     *          - ...
     *
     *
     *
